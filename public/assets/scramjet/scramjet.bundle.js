var A,
  ...
  E = {
    4322: (A) => {
      ...
      function B(A, B) {
        var Q,
          ...
          i,
          o = A.split(";").filter(g),
          D = ((Q = o.shift()), (C = ""), (E = ""), (i = Q.split("=")).length > 1 ? ((C = i.shift()), (E = i.join("="))) : (E = Q), { name: C, value: E }),
          t = D.name,
          e = D.value;
        ...
        try {
          ...
          console.error(`set-cookie-parser encountered an error while decoding a cookie with value '${e}'. Set options.decodeValues to false to disable this feature.`, A);
        }
        ...
        return (
          o.forEach((A) => {
            var I = A.split("="),
              ...
              B = I.join("=");
            "expires" === g ? (s.expires = new Date(B)) : "max-age" === g ? (s.maxAge = parseInt(B, 10)) : "secure" === g ? (s.secure = !0) : "httponly" === g ? (s.httpOnly = !0) : "samesite" === g ? (s.sameSite = B) : "partitioned" === g ? (s.partitioned = !0) : (s[g] = B);
          }),
          s
        );
      }
      function Q(A, Q) {
        ...
        if (A.headers)
          if ("function" === typeof A.headers.getSetCookie) A = A.headers.getSetCookie();
            ...
            var C = A.headers[Object.keys(A.headers).find((A) => "set-cookie" === A.toLowerCase())];
            C || !A.headers.cookie || Q.silent || console.warn("Warning: set-cookie-parser appears to have been called on a request object. It is designed to parse Set-Cookie headers from responses, not Cookie headers from requests. Set the option {silent: true} to suppress this warning."), (A = C);
          }
        return (Array.isArray(A) || (A = [A]), Q.map)
          ? A.filter(g).reduce((A, I) => {
              var g = B(I, Q);
              return (A[g.name] = g), A;
            }, {})
          : A.filter(g).map((A) => B(A, Q));
      }
      (A.exports = Q),
        (A.exports.parse = Q),
        (A.exports.parseString = B),
        (A.exports.splitCookiesString = (A) => {
          ...
          for (; i < A.length; ) {
            for (I = i, C = !1; o(); )
              if ("," === (g = A.charAt(i))) {
                for (B = i, i += 1, o(), Q = i; i < A.length && "=" !== (g = A.charAt(i)) && ";" !== g && "," !== g; ) i += 1;
                i < A.length && "=" === A.charAt(i) ? ((C = !0), (i = Q), E.push(A.substring(I, B)), (I = i)) : (i = B + 1);
              } else i += 1;
    ...
    7302: (A, _I, g) => {
      ...
      (Q.keys = () => Object.keys(B)), (Q.resolve = C), (A.exports = Q), (Q.id = 7302);
    },
    409: (A) => {
      function I(A) {
        var I = Error(`Cannot find module '${A}'`);
    ...
    336: (_A, I, g) => {
      ...
      class r {
        ...
        box;
        constructor(A) {
          if (((this.global = A), B.pX in A)) throw (console.error("attempted to initialize a scramjet client, but one is already loaded - this is very bad"), Error());
          if (e.iswindow) {
            try {
              ...
              : (this.bare = new a.Ay(
                  new Promise((A) => {
                    addEventListener("message", ({ data: I }) => {
                      "object" === typeof I && "$scramjet$type" in I && "baremuxinit" === I.$scramjet$type && A(I.port);
                    });
                  }),
                )),
              ...
              store: new Proxy(
                {},
                {
                  get: (A, I) => {
                    ...
                    if (!Q) return;
                    const C = Reflect.get(Q, B);
                    return (A[I] = C), A[I];
                  },
                },
              ),
              construct(A, ...I) {
                const g = this.store[A];
                return g ? new g(...I) : null;
              },
              call(A, I, ...g) {
                const B = this.store[A];
              ...
              store: new Proxy(
                {},
                {
                  get: (A, g) => {
                    ...
                    if (!C) return;
                    const E = I.natives.call("Object.getOwnPropertyDescriptor", null, C, Q);
                    return (A[g] = E), A[g];
                  },
                },
              ),
          ...
          (this.meta = {
            ...
            get base() {
              if (e.iswindow) {
                const A = I.natives.call("Document.prototype.querySelector", I.global.document, "base");
                if (A) {
            ...
            get topFrameName() {
              ...
              const g = A[B.pX].descriptors.get("window.frameElement", A);
              if (!g) return null;
              if (!g.name) return console.error("YOU NEED TO USE `new ScramjetFrame()`! DIRECT IFRAMES WILL NOT WORK"), null;
              return g.name;
            },
            get parentFrameName() {
              if (!e.iswindow) throw Error("parentFrameName was called from a worker?");
              if (I.global.parent.window === I.global.window) return null;
              const A = I.global.parent.window;
              if (A[B.pX]) {
                const I = A[B.pX].descriptors.get("window.frameElement", A);
                if (!I) return null;
                if (!I.name) return console.error("YOU NEED TO USE `new ScramjetFrame()`! DIRECT IFRAMES WILL NOT WORK"), null;
                return I.name;
              }
              {
                const A = I.descriptors.get("window.frameElement", I.global);
                if (!A.name) return console.error("YOU NEED TO USE `new ScramjetFrame()`! DIRECT IFRAMES WILL NOT WORK"), null;
                return A.name;
              }
            },
          }),
        ...
        get frame() {
          ...
          const A = this.descriptors.get("window.frameElement", this.global);
          if (!A) return null;
          const I = A[B.zr];
          if (!I) {
        ...
        hook() {
          ...
          for (const g of A.keys()) {
            const B = A(g);
            g.endsWith(".ts") && ((g.startsWith("./dom/") && "window" in this.global) || (g.startsWith("./worker/") && "WorkerGlobalScope" in this.global) || g.startsWith("./shared/")) && I.push(B);
          }
          for (const A of (I.sort((A, I) => (A.order || 0) - (I.order || 0)), I)) !A.enabled || A.enabled(this) ? A.default(this, this.global) : A.disabled?.(this, this.global);
        }
        get url() {
        ...
        set url(A) {
          ...
          const I = new i.NavigateEvent(A);
          this.frame?.dispatchEvent(I), I.defaultPrevented || (this.global.location.href = (0, o.Oy)(I.url, this.meta));
        }
        Proxy(A, I) {
          if (Array.isArray(A)) {
            for (const g of A) this.Proxy(g, I);
            return;
          }
          const g = A.split("."),
            B = g.pop(),
            ...
            g.apply &&
              (C.apply = (A, I, B) => {
                ...
                Error.prepareStackTrace = (A, I) => {
                  if (I[0].getFileName() && !I[0].getFileName().startsWith(location.origin + D.$W.prefix)) return { stack: A.stack };
                };
                try {
                  g.apply(E);
                } catch (A) {
                  if (A instanceof Error)
                    if (A.stack instanceof Object) {
                      if (((A.stack = A.stack.stack), console.error("ERROR FROM SCRAMJET INTERNALS", A), !(0, D.U5)("allowFailedIntercepts", this.url))) throw A;
                    } else throw A;
                  else throw A;
                }
        ...
        Trap(A, I) {
          if (Array.isArray(A)) {
            for (const g of A) this.Trap(g, I);
            return;
          }
          const g = A.split("."),
            B = g.pop(),
            Q = g.reduce((A, I) => A?.[I], this.global);
          if (!Q) return;
          const C = this.natives.call("Object.getOwnPropertyDescriptor", null, Q, B);
          return (this.descriptors.store[A] = C), this.RawTrap(Q, B, I);
        }
        RawTrap(A, I, g) {
          if (!A || !I || !Reflect.has(A, I)) return;
          const B = this.natives.call("Object.getOwnPropertyDescriptor", null, A, I),
            Q = {
              this: null,
              get: function () {
          ...
          return (
            ...
            g.set
              ...
              : B?.set && (C.set = B.set),
            g.enumerable ? (C.enumerable = g.enumerable) : B?.enumerable && (C.enumerable = B.enumerable),
            g.configurable ? (C.configurable = g.configurable) : B?.configurable && (C.configurable = B.configurable),
          ...
          get(A) {
            const I = A.get(),
              g = new Proxy(I, {
                    ...
                    : "getNamedItem" === B
                      ...
                      : "getNamedItemNS" === B
                        ...
                        : B in NamedNodeMap.prototype && "function" === typeof C
                          ? new Proxy(C, { apply: (A, B, Q) => (B === g ? Reflect.apply(A, I, Q) : Reflect.apply(A, B, Q)) })
                          : ("string" !== typeof B && "number" !== typeof B) || Number.isNaN(Number(B))
                            ? this.has(A, B)
                              ? C
                              : void 0
                            : I[Object.keys(g)[B]];
                ...
                has: (A, g) => ("symbol" === typeof g ? Reflect.has(A, g) : !(g.startsWith("scramjet-attr-") || I[g]?.name?.startsWith("scramjet-attr-")) && Reflect.has(A, g)),
              });
            return g;
          },
        }),
          A.Trap(["Attr.prototype.value", "Attr.prototype.nodeValue"], { get: (A) => (A.this?.ownerElement ? A.this.ownerElement.getAttribute(A.this.name) : A.get()), set: (A, I) => (A.this?.ownerElement ? A.this.ownerElement.setAttribute(A.this.name, I) : A.set(I)) });
      }
      ...
      function B(A, I) {
        A.serviceWorker.addEventListener("message", ({ data: I }) => {
          if ("scramjet$type" in I && "cookie" === I.scramjet$type) {
            ...
            const g = { scramjet$token: I.scramjet$token, scramjet$type: "cookie" };
          ...
          A.Trap("Document.prototype.cookie", {
            ...
            set(_I, g) {
              ...
              const B = A.descriptors.get("ServiceWorkerContainer.prototype.controller", A.serviceWorker);
              B && A.natives.call("ServiceWorker.prototype.postMessage", B, { scramjet$type: "cookie", cookie: g, url: A.url.href });
            },
          }),
        ...
        A.Proxy("CSSStyleDeclaration.prototype.setProperty", {
          ...
          A.Trap("HTMLElement.prototype.style", {
            get(I) {
              ...
              return new Proxy(g, {
                get(A, I) {
                  const Q = Reflect.get(A, I);
                  return "function" === typeof Q ? new Proxy(Q, { apply: (A, _I, B) => Reflect.apply(A, g, B) }) : I in CSSStyleDeclaration.prototype || !Q ? Q : (0, B.f)(Q);
                },
                set: (I, g, Q) => ("cssText" === g || "" === Q || "string" !== typeof Q ? Reflect.set(I, g, Q) : Reflect.set(I, g, (0, B.s)(Q, A.meta))),
              });
            },
            set(A, I) {
              A.set(I);
    ...
    5351: (_A, I, g) => {
      ...
      function _Q(A, _I) {
        ...
        A.Proxy(["Document.prototype.querySelector", "Document.prototype.querySelectorAll"], {
          apply(A) {
            A.args[0] = g(A.args[0]).replace(/((?:^|\s)\b\w+\[(?:src|href|data-href))[\^]?(=['"]?(?:https?[:])?\/\/)/, "$1*$2");
          },
        }),
          ...
          A.Trap("Document.prototype.referrer", { get: () => A.url.toString() }),
    ...
    7828: (_A, I, g) => {
      ...
      function s(A, I) {
        const g = {
            ...
            src: [I.HTMLImageElement, I.HTMLMediaElement, I.HTMLIFrameElement, I.HTMLFrameElement, I.HTMLEmbedElement, I.HTMLScriptElement, I.HTMLSourceElement],
          ...
          a = [A.natives.call("Object.getOwnPropertyDescriptor", null, I.HTMLAnchorElement.prototype, "href"), A.natives.call("Object.getOwnPropertyDescriptor", null, I.HTMLAreaElement.prototype, "href")];
        for (const I of Object.keys(g))
          for (const B of g[I]) {
            const g = A.natives.call("Object.getOwnPropertyDescriptor", null, B.prototype, I);
            Object.defineProperty(B.prototype, I, {
              get() {
                return ["src", "data", "href", "action", "formaction"].includes(I) ? (0, i.v2)(g.get.call(this)) : g.get.call(this);
              },
              set(A) {
        ...
        for (const I of ["protocol", "hash", "host", "hostname", "origin", "pathname", "port", "search"])
          for (const g in s) {
            const B = s[g],
              Q = a[g];
            A.RawTrap(B, I, {
              get(A) {
                const g = Q.get.call(A.this);
        ...
        A.Trap("Node.prototype.baseURI", {
          get(I) {
            ...
            return (g instanceof Document && (B = g.querySelector("base")), B) ? new URL(B.href, A.url.origin).href : A.url.origin;
          },
          set: (_A, _I) => !1,
        }),
          A.Proxy("Element.prototype.getAttribute", {
            apply(I) {
              ...
              if (A.natives.call("Element.prototype.hasAttribute", I.this, `scramjet-attr-${g}`)) {
                const A = I.fn.call(I.this, `scramjet-attr-${g}`);
          ...
          A.Proxy("Element.prototype.getAttributeNames", {
            apply(A) {
              const I = A.call().filter((A) => !A.startsWith("scramjet-attr"));
              A.return(I);
            },
          }),
          ...
          A.Proxy("Element.prototype.setAttribute", {
            apply(I) {
              const [g, Q] = I.args,
                C = B.V.find((A) => {
                  const B = A[g.toLowerCase()];
                  return !!B && ("*" === B || ("function" !== typeof B && B.includes(I.this.tagName.toLowerCase())));
                });
              if (C) {
                const B = C.fn(Q, A.meta, A.cookieStore);
                if (null == B) {
                  A.natives.call("Element.prototype.removeAttribute", I.this, g), I.return(void 0);
                  return;
                }
          ...
          A.Proxy("Element.prototype.setAttributeNode", { apply(_A) {} }),
          A.Proxy("Element.prototype.setAttributeNS", {
            apply(I) {
              const [_g, Q, C] = I.args,
                E = B.V.find((A) => {
                  const g = A[Q.toLowerCase()];
                  return !!g && ("*" === g || ("function" !== typeof g && g.includes(I.this.tagName.toLowerCase())));
                });
              E && ((I.args[2] = E.fn(C, A.meta, A.cookieStore)), A.natives.call("Element.prototype.setAttribute", I.this, `scramjet-attr-${I.args[1]}`, C));
            },
          }),
          ...
          A.Proxy("Element.prototype.removeAttribute", {
            apply(I) {
              ...
              A.natives.call("Element.prototype.hasAttribute", I.this, I.args[0]) && I.fn.call(I.this, `scramjet-attr-${I.args[0]}`);
            },
          }),
          ...
          A.Trap("Element.prototype.innerHTML", {
            set(g, B) {
              let i;
              if (g.this instanceof I.HTMLScriptElement) (i = (0, E.o)(B, "(anonymous script element)", A.meta)), A.natives.call("Element.prototype.setAttribute", g.this, "scramjet-attr-script-source-src", e(t.encode(i)));
            ...
            get(g) {
              if (g.this instanceof I.HTMLScriptElement) {
                const I = A.natives.call("Element.prototype.getAttribute", g.this, "scramjet-attr-script-source-src");
          ...
          A.Trap("Node.prototype.textContent", {
            set(g, B) {
              if (g.this instanceof I.HTMLScriptElement) {
                const I = (0, E.o)(B, "(anonymous script element)", A.meta);
                return A.natives.call("Element.prototype.setAttribute", g.this, "scramjet-attr-script-source-src", e(t.encode(I))), g.set(I);
              }
          ...
          A.Proxy("Text.prototype.appendData", {
            apply(I) {
              I.this.parentElement?.tagName === "STYLE" && (I.args[0] = (0, Q.s)(I.args[0], A.meta));
            },
          }),
          A.Proxy("Text.prototype.insertData", {
            apply(I) {
              I.this.parentElement?.tagName === "STYLE" && (I.args[1] = (0, Q.s)(I.args[1], A.meta));
            },
          }),
          A.Proxy("Text.prototype.replaceData", {
            apply(I) {
              I.this.parentElement?.tagName === "STYLE" && (I.args[2] = (0, Q.s)(I.args[2], A.meta));
            },
          }),
          A.Trap("Text.prototype.wholeText", { get: (A) => (A.this.parentElement?.tagName === "STYLE" ? (0, Q.f)(A.get()) : A.get()), set: (I, g) => (I.this.parentElement?.tagName === "STYLE" ? I.set((0, Q.s)(g, A.meta)) : I.set(g)) }),
          A.Trap(["HTMLIFrameElement.prototype.contentWindow", "HTMLFrameElement.prototype.contentWindow", "HTMLObjectElement.prototype.contentWindow", "HTMLEmbedElement.prototype.contentWindow"], {
            get(A) {
              const I = A.get();
              return I && (o.pX in I || new D.ScramjetClient(I).hook()), I;
            },
          }),
          A.Trap(["HTMLIFrameElement.prototype.contentDocument", "HTMLFrameElement.prototype.contentDocument", "HTMLObjectElement.prototype.contentDocument", "HTMLEmbedElement.prototype.contentDocument"], {
            get(I) {
              const g = A.descriptors.get(`${I.this.constructor.name}.prototype.contentWindow`, I.this);
              return g ? (o.pX in g || new D.ScramjetClient(g).hook(), g.document) : g;
            },
          }),
          A.Proxy(["HTMLIFrameElement.prototype.getSVGDocument", "HTMLObjectElement.prototype.getSVGDocument", "HTMLEmbedElement.prototype.getSVGDocument"], {
            apply(A) {
    ...
    9804: (_A, I, g) => {
      ...
      function _E(A, _I) {
        A.Proxy(["History.prototype.pushState", "History.prototype.replaceState"], {
          apply(I) {
            (I.args[2] || "" === I.args[2]) && (I.args[2] = (0, B.Oy)(I.args[2], A.meta)), I.call();
            const {
            ...
            if (E.name === A.meta.topFrameName) {
              const I = new Q.UrlChangeEvent(i.url.href);
    ...
    7758: (_A, I, g) => {
      ...
      function _E(A) {
        A.Proxy("window.open", {
          apply(I) {
            I.args[0] && (I.args[0] = (0, C.Oy)(I.args[0], A.meta)), ("_top" === I.args[1] || "_unfencedTop" === I.args[1]) && (I.args[1] = A.meta.topFrameName), "_parent" === I.args[1] && (I.args[1] = A.meta.parentFrameName);
            const g = I.call();
            if (!g) return I.return(g);
            if (Q.pX in g) return I.return(g[Q.pX].global);
            {
              const A = new B.ScramjetClient(g);
    ...
    6012: (_A, I, g) => {
      function B(A, _I) {
        A.Trap("origin", { get: () => A.url.origin, set: () => !1 }), A.Trap("Document.prototype.URL", { get: () => A.url.href, set: () => !1 }), A.Trap("Document.prototype.documentURI", { get: () => A.url.href, set: () => !1 }), A.Trap("Document.prototype.domain", { get: () => A.url.hostname, set: () => !1 });
      }
      g.r(I), g.d(I, { default: () => B });
    },
    6286: (_A, I, g) => {
      ...
      function _C(A, _I) {
        A.Trap("PerformanceEntry.prototype.name", {
          get(A) {
            const I = A.get();
            return I?.startsWith(location.origin + Q.$W.prefix) ? (0, B.v2)(I) : I;
          },
        }),
          A.Proxy(["Performance.prototype.getEntries", "Performance.prototype.getEntriesByType", "Performance.prototype.getEntriesByName", "PerformanceObserverEntryList.prototype.getEntries", "PerformanceObserverEntryList.prototype.getEntriesByType", "PerformanceObserverEntryList.prototype.getEntriesByName"], {
            apply(A) {
              const I = A.call();
              return A.return(
                I.filter((A) => {
                  for (const I of Object.values(Q.$W.files)) if (A.name.startsWith(location.origin + I)) return !1;
                  return !0;
                }),
              );
            },
    ...
    9201: (_A, I, g) => {
      g.r(I), g.d(I, { default: () => o, disabled: () => i, enabled: () => E, order: () => C });
      var B = g(37),
        Q = g(1472);
      const _C = 2,
        _E = (A) => (0, B.U5)("serviceworkers", A.url);
      function i(_A, _I) {
      ...
      function o(A, _I) {
        ...
        A.Proxy("EventTarget.prototype.addEventListener", {
          ...
          A.Trap("ServiceWorkerContainer.prototype.ready", { get: (_A) => new Promise((A) => A(registration)) }),
          A.Trap("ServiceWorkerContainer.prototype.controller", { get: (_A) => registration?.active }),
          A.Proxy("ServiceWorkerContainer.prototype.register", {
            apply(I) {
              const B = new EventTarget();
              Object.setPrototypeOf(B, self.ServiceWorkerRegistration.prototype), (B.constructor = I.fn);
              let C = `${(0, Q.Oy)(I.args[0], A.meta)}?dest=serviceworker`;
              I.args[1] && "module" === I.args[1].type && (C += "&type=module");
              const E = A.natives.construct("SharedWorker", C).port,
                i = { scope: I.args[0], active: E },
                o = A.descriptors.get("ServiceWorkerContainer.prototype.controller", A.serviceWorker);
              A.natives.call("ServiceWorker.prototype.postMessage", o, { scramjet$type: "registerServiceWorker", port: E, origin: A.url.origin }, [E]), g.set(B, i), I.return(new Promise((A) => A(B)));
            },
          });
      }
    },
        ...
        const g = {
          get(I, g) {
            switch (g) {
              ...
              case "clear":
                return () => {
                  for (const g in Object.keys(I)) g.startsWith(A.url.host) && I.removeItem(g);
                };
              case "key":
                return (g) => {
                  const B = Object.keys(I).filter((I) => I.startsWith(A.url.host));
          ...
          getOwnPropertyDescriptor: (I, g) => ({ value: I.getItem(`${A.url.host}@${g}`), enumerable: !0, configurable: !0, writable: !0 }),
          defineProperty: (I, g, B) => (I.setItem(`${A.url.host}@${g}`, B.value), !0),
        };
        I.localStorage;
        const B = new Proxy(I.localStorage, g),
          Q = new Proxy(I.sessionStorage, g);
        delete I.localStorage, delete I.sessionStorage, (I.localStorage = B), (I.sessionStorage = Q);
      }
      g.r(I), g.d(I, { default: () => B });
    },
    1323: (_A, I, g) => {
      g.r(I), g.d(I, { isdedicated: () => s, isemulatedsw: () => w, isshared: () => a, issw: () => e, iswindow: () => D, isworker: () => t, loadAndHook: () => r });
      var B = g(37),
        Q = g(2794),
        C = g(3255),
        E = g(1862),
        i = g(8409),
        o = g(8665).A;
      const D = "window" in globalThis && window instanceof Window,
        ...
        w = "location" in globalThis && "serviceworker" === new URL(globalThis.location.href).searchParams.get("dest");
      function r(A) {
        if (((0, B.Nk)(A), o.log("initializing scramjet client"), !(Q.pX in globalThis))) {
          (0, B.Ec)();
          const A = new C.ScramjetClient(globalThis),
          ...
          const g = new E.ScramjetContextEvent(A.global.window, A);
          A.frame?.dispatchEvent(g);
          const Q = new E.UrlChangeEvent(A.url.href);
    ...
    1862: (_A, I, g) => {
      g.r(I), g.d(I, { NavigateEvent: () => Q, ScramjetContextEvent: () => E, ScramjetGlobalDownloadEvent: () => B, UrlChangeEvent: () => C });
    ...
    3696: (_A, I, g) => {
      ...
      var B = g(1862),
        ...
        C = g(1323);
      function _E(A, I) {
        const g = C.iswindow ? I.Location : I.WorkerLocation,
          E = {};
        Object.setPrototypeOf(E, g.prototype), (E.constructor = g);
        const i = C.iswindow ? I.location : g.prototype;
        for (const g of ["protocol", "hash", "host", "hostname", "href", "origin", "pathname", "port", "search"]) {
          const Q = A.natives.call("Object.getOwnPropertyDescriptor", null, i, g);
          if (!Q) continue;
          const C = { configurable: !1, enumerable: !0 };
            ...
            Q.set &&
              (C.set = new Proxy(Q.set, {
                apply(_Q, _C, E) {
                  ...
                  if ("hash" === g) {
                    I.location.hash = E[0];
                    const g = new B.UrlChangeEvent(A.url.href);
                    A.isSubframe || A.frame?.dispatchEvent(g);
                    return;
                  }
                  const i = new URL(A.url.href);
                  (i[g] = E[0]), (A.url = i);
                },
              })),
        ...
        return (
          (E.toString = new Proxy(I.location.toString, { apply: () => A.url.href })),
          I.location.valueOf && (E.valueOf = new Proxy(I.location.valueOf, { apply: () => A.url.href })),
          I.location.assign &&
            (E.assign = new Proxy(I.location.assign, {
              apply(g, _C, E) {
                (E[0] = (0, Q.Oy)(E[0], A.meta)), Reflect.apply(g, I.location, E);
                const i = new B.UrlChangeEvent(A.url.href);
    ...
    8382: (_A, I, g) => {
      function B(A) {
        ...
        const I = console.log;
        A.Trap("console.log", { set(_A, _I) {}, get: (_A) => I });
      }
      g.r(I), g.d(I, { default: () => B });
    },
    4634: (_A, I, g) => {
      ...
      function _Q(A, _I) {
        A.Proxy("CacheStorage.prototype.open", {
          ...
          A.Proxy("CacheStorage.prototype.match", {
            apply(I) {
              ("string" === typeof I.args[0] || I.args[0] instanceof URL) && (I.args[0] = (0, B.Oy)(I.args[0], A.meta));
            },
          }),
          ...
          A.Proxy("Cache.prototype.addAll", {
            apply(I) {
              for (let g = 0; g < I.args[0].length; g++) ("string" === typeof I.args[0][g] || I.args[0][g] instanceof URL) && (I.args[0][g] = (0, B.Oy)(I.args[0][g], A.meta));
            },
          }),
          ...
          A.Proxy("Cache.prototype.matchAll", {
            apply(I) {
              ((I.args[0] && "string" === typeof I.args[0]) || (I.args[0] && I.args[0] instanceof URL)) && (I.args[0] = (0, B.Oy)(I.args[0], A.meta));
            },
          }),
    ...
    582: (_A, I, g) => {
      ...
      var B = g(37);
      const _Q = (A) => (0, B.U5)("captureErrors", A.url);
      function C(A, I = []) {
        switch (typeof A) {
          case "string":
            break;
          case "object":
            if (A?.[Symbol.iterator] && "function" === typeof A[Symbol.iterator])
              for (const g in A) {
      ...
      function _E(A, I) {
        ...
        (I.$scramerr = (A) => {
          ...
          (I.$scramdbg = (A, I) => (A && "object" === typeof A && A.length > 0 && C(A), C(I), I)),
    ...
    6143: (_A, I, g) => {
      ...
      var B = g(37),
        Q = g(1472);
      const _C = (A) => (0, B.U5)("cleanErrors", A.url);
      function _E(A, _I) {
        const g = (A, I) => {
          let g = A.stack;
          for (let A = 0; A < I.length; A++) {
            const C = I[A].getFileName();
            try {
        ...
        A.Trap("Error.prepareStackTrace", { get: (_A) => g, set(_A) {} });
      }
    },
    591: (_A, I, g) => {
      ...
      var B = g(37),
        Q = g(1478);
      function _C(A, I) {
        Object.defineProperty(I, B.$W.globals.rewritefn, { value: (I) => ("string" !== typeof I ? I : (0, Q.o)(I, "(direct eval proxy)", A.meta)), writable: !1, configurable: !1 });
      }
      function _E(_A, I) {
        let g;
    ...
    3481: (_A, I, g) => {
      ...
      var B = g(1323),
        Q = g(1472),
        C = g(94);
      const E = Symbol.for("scramjet original onevent function");
      function i(A, I) {
        const g = {
          message: {
            _init() {
            ...
            origin() {
              return "object" === typeof this.data && "$scramjet$origin" in this.data ? this.data.$scramjet$origin : A.url.origin;
            },
            data() {
            ...
            apply(A, B, Q) {
              ...
              if (E.isTrusted) {
                ...
                if (A in g) {
                  ...
                  Q[0] = new Proxy(E, {
                    get(A, g, B) {
                      const Q = Reflect.get(A, g);
                      return g in I ? I[g].call(A) : "function" === typeof Q ? new Proxy(Q, { apply: (A, I, g) => (I === B ? Reflect.apply(A, E, g) : Reflect.apply(A, I, g)) }) : Q;
                    },
                    getOwnPropertyDescriptor: C.getOwnPropertyDescriptorHandler,
                  });
                }
              }
              return I.event || Object.defineProperty(I, "event", { get: () => Q[0], configurable: !0 }), Reflect.apply(A, B, Q);
            },
            getOwnPropertyDescriptor: C.getOwnPropertyDescriptorHandler,
          });
        }
        A.Proxy("EventTarget.prototype.addEventListener", {
          apply(I) {
            ...
            (Q ||= []).push({ event: I.args[0], originalCallback: g, proxiedCallback: B }), A.eventcallbacks.set(I.this, Q);
          },
        }),
          A.Proxy("EventTarget.prototype.removeEventListener", {
            apply(I) {
              if ("function" !== typeof I.args[1]) return;
              const g = A.eventcallbacks.get(I.this);
              if (!g) return;
              const B = g.findIndex((A) => A.event === I.args[0] && A.originalCallback === I.args[1]);
              if (-1 === B) return;
              const Q = g.splice(B, 1);
              A.eventcallbacks.set(I.this, g), (I.args[1] = Q[0].proxiedCallback);
            },
          });
        const o = [I.self, I.MessagePort.prototype];
        for (const Q of (B.iswindow && o.push(I.HTMLElement.prototype), I.Worker && o.push(I.Worker.prototype), o))
          for (const I of Reflect.ownKeys(Q))
            if ("string" === typeof I && I.startsWith("on") && g[I.slice(2)]) {
              const g = A.natives.call("Object.getOwnPropertyDescriptor", null, Q, I);
    ...
    249: (_A, I, g) => {
      ...
      function _C(A, _I) {
        ...
        A.Proxy("Function", g);
        const B = A.natives.call("eval", null, "(function () {})").constructor,
        ...
        A.RawProxy(B.prototype, "constructor", g), A.RawProxy(C.prototype, "constructor", g), A.RawProxy(E.prototype, "constructor", g), A.RawProxy(i.prototype, "constructor", g);
      }
    },
    2468: (_A, I, g) => {
      g.r(I), g.d(I, { default: () => C });
      var B = g(37),
        Q = g(1472);
      function _C(A, I) {
        const g = A.natives.call("Function", null, "url", "return import(url)");
        Object.defineProperty(I, B.$W.globals.importfn, {
          value: (I, B) => {
            const C = new URL(B, I).href;
            return B.includes(":") || B.startsWith("/") || B.startsWith(".") || B.startsWith("..") ? g(`${(0, Q.Oy)(C, A.meta)}?type=module`) : g(B);
          },
          writable: !1,
          configurable: !1,
          enumerable: !1,
        }),
          Object.defineProperty(I, B.$W.globals.metafn, { value: (A, I) => ((A.url = I), (A.resolve = (A) => new URL(A, I).href), A), writable: !1, configurable: !1, enumerable: !1 });
      }
    },
    4338: (_A, I, g) => {
      function B(A) {
        ...
        A.Proxy("StorageManager.prototype.getDirectory", {
          apply(I) {
            ...
            I.return(
              (async () => {
                const I = await g,
                  B = await I.getDirectoryHandle(`${A.url.origin.replace(/\/|\s|\./g, "-")}`, { create: !0 });
          ...
          A.Proxy("window.postMessage", {
            apply(A) {
              const {
                ...
                } = "object" === typeof A.args[0] && null !== A.args[0] ? A.args[0] : "object" === typeof A.args[2] && null !== A.args[2] ? A.args[2] : A.this && C.POLLUTANT in A.this && "object" === typeof A.this[C.POLLUTANT] && null !== A.this[C.POLLUTANT] ? A.this[C.POLLUTANT] : {},
                g = I("return globalThis")()[Q.pX],
                B = I("...args", "this(...args)");
              (A.args[0] = { $scramjet$messagetype: "window", $scramjet$origin: g.url.origin, $scramjet$data: A.args[0] }), "string" === typeof A.args[1] && (A.args[1] = "*"), "object" === typeof A.args[1] && (A.args[1].targetOrigin = "*"), A.return(B.call(A.fn, ...A.args));
            },
          });
        const I = ["MessagePort.prototype.postMessage"];
        self.Worker && I.push("Worker.prototype.postMessage"),
          B.iswindow || I.push("self.postMessage"),
          A.Proxy(I, {
            apply(A) {
              A.args[0] = { $scramjet$messagetype: "worker", $scramjet$data: A.args[0] };
            },
          });
      }
    },
    1914: (_A, I, g) => {
      ...
      var B = g(37);
      const Q = Symbol.for("scramjet realm pollutant");
      function _C(_A, I) {
        Object.defineProperty(I.Object.prototype, B.$W.globals.setrealmfn, {
          value(A) {
            return Object.defineProperty(this, Q, { value: A, writable: !1, configurable: !0, enumerable: !1 }), this;
          },
          writable: !0,
          configurable: !0,
          enumerable: !1,
    ...
    6972: (_A, I, g) => {
      ...
      function _C(A) {
        A.Proxy("fetch", {
          apply(I) {
            ("string" === typeof I.args[0] || I.args[0] instanceof URL) && ((I.args[0] = (0, Q.Oy)(I.args[0], A.meta)), B.isemulatedsw && (I.args[0] += "?from=swruntime"));
          },
        }),
          A.Proxy("Request", {
            construct(I) {
      ...
      function B(A, I) {
        ...
        A.Proxy("WebSocket", {
          construct(B) {
            ...
            const C = A.bare.createWebSocket(B.args[0], B.args[1], null, { "User-Agent": I.navigator.userAgent, Origin: A.url.origin }),
              E = { extensions: "", protocol: "", url: B.args[0], binaryType: "blob", barews: C, onclose: null, onerror: null, onmessage: null, onopen: null };
            function i(A) {
              E[`on${A.type}`]?.(new Proxy(A, { get: (A, I) => "isTrusted" === I || Reflect.get(A, I) })), Q.dispatchEvent(A);
            }
            C.addEventListener("open", () => {
              ...
              C.addEventListener("message", async (A) => {
                let I = A.data;
                "string" === typeof I || ("byteLength" in I ? ("blob" === E.binaryType ? (I = new Blob([I])) : Object.setPrototypeOf(I, ArrayBuffer.prototype)) : "arrayBuffer" in I && "arraybuffer" === E.binaryType && Object.setPrototypeOf((I = await I.arrayBuffer()), ArrayBuffer.prototype)),
                  i(new MessageEvent("message", { data: I, origin: A.origin, lastEventId: A.lastEventId, source: A.source, ports: A.ports }));
              }),
          ...
          A.Trap("WebSocket.prototype.binaryType", {
            ...
            set(A, I) {
              const B = g.get(A.this);
              ("blob" === I || "arraybuffer" === I) && (B.binaryType = I);
            },
          }),
          A.Trap("WebSocket.prototype.bufferedAmount", { get: () => 0 }),
          A.Trap("WebSocket.prototype.extensions", { get: (A) => g.get(A.this).extensions }),
          ...
          A.Trap("WebSocket.prototype.protocol", { get: (A) => g.get(A.this).protocol }),
          A.Trap("WebSocket.prototype.readyState", { get: (A) => g.get(A.this).barews.readyState }),
          A.Proxy("WebSocket.prototype.send", {
            apply(A) {
              const I = g.get(A.this);
          ...
          A.Proxy("WebSocket.prototype.close", {
            apply(A) {
              const I = g.get(A.this);
              void 0 === A.args[0] && (A.args[0] = 1e3), void 0 === A.args[1] && (A.args[1] = ""), A.return(I.barews.close(A.args[0], A.args[1]));
            },
          }),
          A.Proxy("WebSocketStream", {
            construct(g) {
              ...
              const o = A.bare.createWebSocket(g.args[0], g.args[1], null, { "User-Agent": I.navigator.userAgent, Origin: A.url.origin });
                ...
                readable: new ReadableStream({
                  start(A) {
                    o.addEventListener("message", async (I) => {
                      let g = I.data;
                      "string" === typeof g || ("byteLength" in g ? Object.setPrototypeOf(g, ArrayBuffer.prototype) : "arrayBuffer" in g && Object.setPrototypeOf((g = await g.arrayBuffer()), ArrayBuffer.prototype)), A.enqueue(g);
                    });
                  },
                }),
              ...
              o.addEventListener("open", () => {
                Q({ readable: D.readable, writable: D.writable, extensions: D.extensions, protocol: D.protocol });
              }),
          ...
          A.Trap("WebSocketStream.prototype.closed", { get: (A) => B.get(A.this).closed }),
          A.Trap("WebSocketStream.prototype.opened", { get: (A) => B.get(A.this).opened }),
          A.Trap("WebSocketStream.prototype.url", { get: (A) => B.get(A.this).url }),
          A.Proxy("WebSocketStream.prototype.close", {
            apply(A) {
              const I = B.get(A.this);
              return A.args[0] ? (void 0 === A.args[0].closeCode && (A.args[0].closeCode = 1e3), void 0 === A.args[0].reason && (A.args[0].reason = ""), A.return(I.barews.close(A.args[0].closeCode, A.args[0].reason))) : A.return(I.barews.close(1e3, ""));
            },
          });
      }
      g.r(I), g.d(I, { default: () => B });
    ...
    248: (_A, I, g) => {
      ...
      function _C(A, I) {
        let g;
        I.Worker && (0, B.U5)("syncxhr", A.url) && (g = A.natives.construct("Worker", B.$W.files.sync));
        const C = Symbol("xhr original args"),
          E = Symbol("xhr headers");
        A.Proxy("XMLHttpRequest.prototype.open", {
          apply(I) {
            I.args[1] && (I.args[1] = (0, Q.Oy)(I.args[1], A.meta)), void 0 === I.args[2] && (I.args[2] = !0), (I.this[C] = I.args);
          },
        }),
          ...
          A.Proxy("XMLHttpRequest.prototype.send", {
            apply(I) {
              const Q = I.this[C];
              if (!Q || Q[2]) return;
              if (!(0, B.U5)("syncxhr", A.url)) return console.warn("ignoring request - sync xhr disabled in flags"), I.return(void 0);
              const i = new SharedArrayBuffer(1024, { maxByteLength: 0x7fffffff }),
                o = new DataView(i);
              A.natives.call("Worker.prototype.postMessage", g, { sab: i, args: Q, headers: I.this[E], body: I.args[0] });
              const D = performance.now();
              for (; 0 === o.getUint8(0); ) if (performance.now() - D > 1e3) throw Error("xhr timeout");
              const t = o.getUint16(1),
                e = o.getUint32(3),
                s = new Uint8Array(e);
              ...
              A.RawTrap(I.this, "status", { get: () => t }),
                ...
                A.RawTrap(I.this, "response", { get: () => ("arraybuffer" === I.this.responseType ? r.buffer : h) }),
                A.RawTrap(I.this, "responseXML", { get: () => new DOMParser().parseFromString(h, "text/xml") }),
                A.RawTrap(I.this, "getAllResponseHeaders", { get: () => () => a }),
                A.RawTrap(I.this, "getResponseHeader", {
                  get: () => (A) => {
                    const I = RegExp(`^${A}: (.*)$`, "m").exec(a);
                    return I ? I[1] : null;
                  },
                }),
                I.return(void 0);
          ...
          A.Trap("XMLHttpRequest.prototype.responseURL", { get: (A) => (0, Q.v2)(A.get()) });
      }
    },
    7418: (_A, I, g) => {
      g.r(I), g.d(I, { default: () => Q });
      ...
      function _Q(A, _I) {
        A.Proxy(["setTimeout", "setInterval"], {
          apply(I) {
            I.args.length > 0 && "string" === typeof I.args[0] && (I.args[0] = (0, B.o)(I.args[0], "(setTimeout string eval)", A.meta));
          },
        });
      }
    },
        ...
        Object.defineProperty(I, B.$W.globals.pushsourcemapfn, {
          value: (I, g) => {
            ...
            !((A, I, g) => {
              let B = Uint8Array.from(I),
                ...
                o = 4;
              for (let A = 0; A < i; A++) {
                const A = Q.getUint32(o, !0);
                o += 4;
                const I = Q.getUint32(o, !0);
                o += 4;
                const g = Q.getUint8(o);
                if (((o += 1), 0 === g)) E.push({ type: g, start: A, size: I });
                else if (1 === g) {
                  const i = A + I,
                    D = Q.getUint32(o, !0);
                  o += 4;
                  const t = C.decode(B.subarray(o, o + D));
          ...
          A.Proxy("Function.prototype.toString", {
            apply(I) {
              performance.now(),
                ((A, I) => {
                  const g = I.fn.call(I.this),
                    B = ((A) => {
                      const I = A.indexOf(C);
                      if (-1 === I) return null;
                      const g = A.indexOf("*/", I);
                      if (-1 === g) throw (console.log(A, I, g), Error("unreachable"));
                      const B = A.substring(I + 2, g).split(" ");
                      if (3 !== B.length || "scramtag" !== B[0] || !Number.isSafeInteger(+B[1])) throw (console.log(A, I, g, B), Error("invalid tag"));
                      return [B[2], I, +B[1]];
                    })(g);
    ...
    9399: (_A, I, g) => {
      ...
      function _C(A, _I) {
        A.Proxy("Worker", {
          construct(I) {
            (I.args[0] = `${(0, Q.Oy)(I.args[0], A.meta)}?dest=worker`), I.args[1] && "module" === I.args[1].type && (I.args[0] += "&type=module");
            const g = I.call(),
              C = new B.DD();
            (async () => {
              const I = await C.getInnerPort();
              A.natives.call("Worker.prototype.postMessage", g, { $scramjet$type: "baremuxinit", port: I }, [I]);
            })();
          },
        }),
          A.Proxy("SharedWorker", {
            construct(I) {
              (I.args[0] = `${(0, Q.Oy)(I.args[0], A.meta)}?dest=sharedworker`),
                I.args[1] && "string" === typeof I.args[1] && (I.args[1] = `${A.url.origin}@${I.args[1]}`),
                I.args[1] && "object" === typeof I.args[1] && ("module" === I.args[1].type && (I.args[0] += "&type=module"), I.args[1].name && (I.args[1].name = `${A.url.origin}@${I.args[1].name}`));
              const g = I.call(),
                C = new B.DD();
              (async () => {
                const I = await C.getInnerPort();
                A.natives.call("MessagePort.prototype.postMessage", g.port, { $scramjet$type: "baremuxinit", port: I }, [I]);
              })();
            },
          }),
    ...
    581: (_A, I, g) => {
      ...
      const o = 4;
      function D(A, I) {
        Object.defineProperty(I, C.$W.globals.wrapfn, { value: A.wrapfn, writable: !1, configurable: !1, enumerable: !1 }),
          Object.defineProperty(I, C.$W.globals.wrappropertyfn, { value: (A) => ("location" === A || "parent" === A || "top" === A || "eval" === A ? C.$W.globals.wrappropertybase + A : A), writable: !1, configurable: !1, enumerable: !1 }),
          Object.defineProperty(I, C.$W.globals.cleanrestfn, { value: (_A) => {}, writable: !1, configurable: !1, enumerable: !1 }),
          ...
          (I.$scramitize = (A) => (location, B.iswindow && I.top, "string" === typeof A && A.includes("scramjet"), "string" === typeof A && A.includes(location.origin), A)),
          Object.defineProperty(I, C.$W.globals.trysetfn, { value: (g, _B, Q) => g instanceof I.Location && ((A.locationProxy.href = Q), !0), writable: !1, configurable: !1 });
      }
    },
    1229: (_A, I, g) => {
      ...
      class B {
        ...
        registerClient(A, I) {
          this.clients.push(A), this.globals.set(I, A), this.documents.set(I.document, A), this.locations.set(I.location, A);
        }
      }
    },
    8409: (_A, I, g) => {
      ...
      class C {
            ...
            (self.onconnect = (I) => {
              ...
              Q.log("sw", "connected"),
                g.addEventListener("message", (I) => {
                  console.log("sw", I.data), "scramjet$type" in I.data && ("init" === I.data.scramjet$type ? ((this.recvport = I.data.scramjet$port), this.recvport.postMessage({ scramjet$type: "init" })) : E.call(this, A, I.data));
                }),
                g.start();
            });
        }
        hook() {
          (this.client.global.registration = {
            ...
            active: { scriptURL: this.client.url.href, state: "activated", onstatechange: null, onerror: null, postMessage: () => {}, addEventListener: () => {}, removeEventListener: () => {}, dispatchEvent: (_A) => !1 },
      ...
      function _E(A, I) {
        const g = this.recvport,
          C = I.scramjet$type,
          E = I.scramjet$token,
          i = A.eventcallbacks.get(self);
        if ("fetch" === C) {
          Q.log("ee", I);
          const C = i.filter((A) => "fetch" === A.event);
          if (!C) return;
          for (const i of C) {
            const C = I.scramjet$request,
              o = new A.natives.Request((0, B.v2)(C.url), { body: C.body, headers: new Headers(C.headers), method: C.method, mode: "same-origin" });
            Object.defineProperty(o, "destination", { value: C.destinitation });
            const D = new Event("fetch");
            D.request = o;
            let t = !1;
            (D.respondWith = (A) => {
              (t = !0),
                (async () => {
                  const I = { scramjet$type: "fetch", scramjet$token: E, scramjet$response: { body: (A = await A).body, headers: Array.from(A.headers.entries()), status: A.status, statusText: A.statusText } };
                  Q.log("sw", "responding", I), g.postMessage(I, [A.body]);
                })();
            }),
              Q.log("to fn", D),
              i.proxiedCallback(new Proxy(D, { get: (A, I, _g) => "isTrusted" === I || Reflect.get(A, I) })),
              t || (console.log("sw", "no response"), g.postMessage({ scramjet$type: "fetch", scramjet$token: E, scramjet$response: !1 }));
          }
        }
      }
    },
    9353: (_A, I, g) => {
      ...
      function _Q(A) {
        A.Proxy("importScripts", {
          apply(I) {
            for (const g in I.args) I.args[g] = (0, B.Oy)(I.args[g], A.meta);
          },
        });
      }
    },
    3402: (_A, I, g) => {
      ...
      class o extends EventTarget {
        ...
        constructor(A) {
          super();
          const I = (A, g) => {
              for (const B in g) g[B] instanceof Object && B in A && Object.assign(g[B], I(A[B], g[B]));
            ...
            g = I(
              {
                ...
                siteFlags: {},
                codec: { encode: (A) => (A ? encodeURIComponent(A) : A), decode: (A) => (A ? decodeURIComponent(A) : A) },
              },
              A,
            );
          (g.codec.encode = g.codec.encode.toString()), (g.codec.decode = g.codec.decode.toString()), (0, B.Nk)(g);
        }
        async init() {
          (0, B.Ec)(),
            await this.openIDB(),
            navigator.serviceWorker.controller?.postMessage({ scramjet$type: "loadConfig", config: B.$W }),
            i.log("config loaded"),
            navigator.serviceWorker.addEventListener("message", (A) => {
              if (!("scramjet$type" in A.data)) return;
              const I = A.data;
              "download" === I.scramjet$type && this.dispatchEvent(new E.ScramjetGlobalDownloadEvent(I.download));
            });
        }
        createFrame(A) {
        ...
        encodeUrl(A) {
          if (("string" === typeof A && (A = new URL(A)), "http:" !== A.protocol && "https:" !== A.protocol)) return A.href;
          const I = (0, B.hD)(A.hash.slice(1));
          return (A.hash = ""), B.$W.prefix + (0, B.hD)(A.href) + (I ? `#${I}` : "");
        }
        decodeUrl(A) {
          A instanceof URL && (A = A.toString());
          const I = location.origin + B.$W.prefix;
          return (0, B.P_)(A.slice(I.length));
        }
        async openIDB() {
          const A = await (0, C.P2)("$scramjet", 1, {
            upgrade(A) {
              A.objectStoreNames.contains("config") || A.createObjectStore("config"),
                ...
                A.objectStoreNames.contains("redirectTrackers") || A.createObjectStore("redirectTrackers"),
                A.objectStoreNames.contains("referrerPolicies") || A.createObjectStore("referrerPolicies"),
                A.objectStoreNames.contains("publicSuffixList") || A.createObjectStore("publicSuffixList");
            },
          });
        ...
        async modifyConfig(A) {
          (0, B.Nk)(Object.assign({}, B.$W, A)), (0, B.Ec)(), await this.#A(), navigator.serviceWorker.controller?.postMessage({ scramjet$type: "loadConfig", config: B.$W });
        }
    ...
    4869: (_A, I, g) => {
      ...
      class C extends EventTarget {
        ...
        go(A) {
          A instanceof URL && (A = A.toString()), Q.log("navigated to", A), (this.frame.src = this.controller.encodeUrl(A));
        }
        back() {
    ...
    8083: (_A, I, g) => {
      ...
      g.d(I, { AL: () => C, HT: () => Q, aR: () => B, q9: () => E }), (globalThis.$scramjetRequire = (A) => g(409)(A));
      const E = { build: "667cf55", version: "2.0.0-alpha" };
      (globalThis.$scramjetLoadController = B), (globalThis.$scramjetLoadClient = Q), (globalThis.$scramjetLoadWorker = C), (globalThis.$scramjetVersion = E), "document" in globalThis && document?.currentScript && document.currentScript.remove();
    },
    8665: (_A, I, g) => {
      g.d(I, { A: () => Q });
      const B = { log: console.log, warn: console.warn, error: console.error, debug: console.debug, info: console.info },
        _Q = {
          fmt: function (A, I, ...g) {
            const B = Error.prepareStackTrace;
            Error.prepareStackTrace = (_A, I) => {
              I.shift(), I.shift(), I.shift();
              let g = "";
              for (let A = 1; A < Math.min(2, I.length); A++) I[A].getFunctionName() && (g += `${I[A].getFunctionName()} -> ${g}`);
  ...
  `,
      ...
      class C {
        ...
        setCookies(A, I) {
          for (const g of A) {
            ...
            B.domain || (B.domain = `.${I.hostname}`), B.domain.startsWith(".") || (B.domain = `.${B.domain}`), B.path || (B.path = "/"), B.sameSite || (B.sameSite = "lax"), B.expires && (B.expires = B.expires.toString());
            const C = `${B.domain}@${B.path}@${B.name}`;
            this.cookies[C] = B;
          }
        }
        getCookies(A, I) {
          ...
          for (const C of B) {
            ...
            (!C.secure || "https:" === A.protocol) && (!C.httpOnly || !I) && A.pathname.startsWith(C.path) && (!C.domain.startsWith(".") || A.hostname.endsWith(C.domain.slice(1))) && Q.push(C);
          }
    ...
    2393: (_A, I, g) => {
      ...
      var B = g(2614),
        ...
        C = g(1472);
      const _E = [
        { fn: (A, I) => (0, C.Oy)(A, I), src: ["embed", "script", "img", "frame", "source", "input", "track"], href: ["a", "link", "area", "use", "image"], data: ["object"], action: ["form"], formaction: ["button", "input", "textarea", "submit"], poster: ["video"], "xlink:href": ["image"] },
        { fn: (A, I) => (0, C.Oy)(A, I), src: ["iframe"] },
        { fn: (_A, _I) => null, sandbox: ["iframe"] },
        { fn: (A, I) => (A.startsWith("blob:") ? (0, C.$n)(A) : (0, C.Oy)(A, I)), src: ["video", "audio"] },
        { fn: () => "", integrity: ["script", "link"] },
        { fn: () => null, nonce: "*", csp: ["iframe"], credentialless: ["iframe"] },
        { fn: (A, I) => (0, Q.PV)(A, I), srcset: ["img", "source"], imagesrcset: ["link"] },
        { fn: (A, I, g) => (0, Q.Qs)(A, g, { origin: new URL(I.origin.origin), base: new URL(I.origin.origin) }, !0), srcdoc: ["iframe"] },
        { fn: (A, I) => (0, B.s)(A, I), style: "*" },
        { fn: (A, I) => ("_top" === A || "_unfencedTop" === A ? I.topFrameName : "_parent" === A ? I.parentFrameName : A), target: ["a", "base"] },
      ];
    },
    37: (_A, I, g) => {
      let B, Q, C;
      ...
      function a(A, I) {
        const g = C.flags[A];
        for (const g in C.siteFlags) {
          const B = C.siteFlags[g];
    ...
    2614: (_A, I, g) => {
      ...
      function _E(A, I, g) {
        return (I = (I = new String(I).toString()).replace(/url\(['"]?(.+?)['"]?\)/gm, (I, Q) => {
          const C = "rewrite" === A ? (0, B.Oy)(Q.trim(), g) : (0, B.v2)(Q.trim());
          return I.replace(Q, C);
        })).replace(/@import\s+(url\s*?\(.{0,9999}?\)|['"].{0,9999}?['"]|.{0,9999}?)($|\s|;)/gm, (I, Q) =>
          I.replace(
            Q,
            Q.replace(/^(url\(['"]?|['"]|)(.+?)(['"]|['"]?\)|)$/gm, (I, Q, C, E) => {
              if (Q.startsWith("url")) return I;
              const i = "rewrite" === A ? (0, B.Oy)(C.trim(), g) : (0, B.v2)(C.trim());
              return `${Q}${i}${E}`;
            }),
          ),
        );
    ...
    4435: (_A, I, g) => {
      ...
      async function o(A, I, g, o) {
        const D = {};
        for (const I in A) D[I.toLowerCase()] = A[I];
        for (const A of C) delete D[A];
        for (const A of E) D[A] && (D[A] = (0, B.Oy)(D[A]?.toString(), I));
        if (("string" === typeof D.link ? (D.link = i(D.link, I)) : Array.isArray(D.link) && (D.link = D.link.map((A) => i(A, I))), "string" === typeof D.referer)) {
          const A = new URL(D.referer),
          ...
          if (g) {
            const B = g.policy
              ...
              .split(",")
              .map((A) => A.trim());
            B.includes("no-referrer") || (B.includes("no-referrer-when-downgrade") && "http:" === I.origin.protocol && "https:" === A.protocol)
              ? delete D.referer
              : B.includes("origin")
                ? (D.referer = A.origin)
        ...
        return (
          "string" === typeof D["sec-fetch-dest"] && "" === D["sec-fetch-dest"] && (D["sec-fetch-dest"] = "empty"),
          "string" === typeof D["sec-fetch-site"] &&
            "none" !== D["sec-fetch-site"] &&
            ("string" === typeof D.referer ? (D["sec-fetch-site"] = await (0, Q.ps)(I, new URL(D.referer), g)) : (console.warn("Missing referrer header; can't rewrite sec-fetch-site properly. Falling back to unsafe deletion."), delete D["sec-fetch-site"])),
          D
        );
      }
    },
	...
	`,
          Q = c(a.encode(B));
        return [I(D.$W.files.wasm), I(D.$W.files.all), I(`data:application/javascript;base64,${Q}`)];
      }
      const a = new TextEncoder();
      function w(A, I, g, D = !1) {
        const r = performance.now(),
          h = ((A, I, g, D = !1) => {
            const e = new Q.DV((_A, I) => I),
              w = new B.iX(e);
            if (
              (w.write(A),
              w.end(),
              (function A(I, g, B) {
                if (("base" === I.name && void 0 !== I.attribs.href && (B.base = new URL(I.attribs.href, B.origin)), I.attribs)) {
                  for (const A of t.V)
                    for (const Q in A) {
                      const C = A[Q.toLowerCase()];
                      if ("function" !== typeof C && ("*" === C || C.includes(I.name)) && void 0 !== I.attribs[Q]) {
                        const C = I.attribs[Q],
                          E = A.fn(C, B, g);
                        null === E ? delete I.attribs[Q] : (I.attribs[Q] = E), (I.attribs[`scramjet-attr-${Q}`] = C);
                      }
                    }
                  for (const [A, g] of Object.entries(I.attribs)) S.includes(A) && ((I.attribs[`scramjet-attr-${A}`] = g), (I.attribs[A] = (0, o.o)(g, `(inline ${A} on element)`, B)));
                }
                if (
                  ("style" === I.name && void 0 !== I.children[0] && (I.children[0].data = (0, i.s)(I.children[0].data, B)),
                  "script" === I.name && "module" === I.attribs.type && I.attribs.src && (I.attribs.src = `${I.attribs.src}?type=module`),
                  "script" === I.name && "importmap" === I.attribs.type && void 0 !== I.children[0])
                ) {
                  const A = I.children[0].data;
                  try {
                    const g = JSON.parse(A);
                    if (g.imports)
                      for (const A in g.imports) {
                        let I = g.imports[A];
                ...
                if ("script" === I.name && /(application|text)\/javascript|module|undefined/.test(I.attribs.type) && void 0 !== I.children[0]) {
                  let A = I.children[0].data,
                    g = "module" === I.attribs.type;
                  (I.attribs["scramjet-attr-script-source-src"] = c(a.encode(A))), (A = A.replace(/<!--[\s\S]*?-->/g, "")), (I.children[0].data = (0, o.o)(A, "(inline script element)", B, g));
                }
                if ("meta" === I.name && void 0 !== I.attribs["http-equiv"]) {
                  if ("content-security-policy" === I.attribs["http-equiv"].toLowerCase()) I = new Q.Mw(I.attribs.content);
                  else if ("refresh" === I.attribs["http-equiv"] && I.attribs.content.includes("url")) {
                    const A = I.attribs.content.split("url=");
                    A[1] && (A[1] = (0, E.Oy)(A[1].trim(), B)), (I.attribs.content = A.join("url="));
                  }
                }
                if (I.childNodes) for (const Q in I.childNodes) I.childNodes[Q] = A(I.childNodes[Q], g, B);
                return I;
              })(e.root, I, g),
              D)
            ) {
              let A = (function A(I) {
                ...
                if (I.childNodes)
                  for (const g of I.childNodes) {
                    const I = A(g);
                    if (I) return I;
                  }
                return null;
              })(e.root);
              A || ((A = new Q.Hg("head", {}, [])), e.root.children.unshift(A)), A.children.unshift(...s(I, (A) => new Q.Hg("script", { src: A })));
            }
            return (0, C.A)(e.root, { encodeEntities: "utf8", decodeEntities: !1 });
          })(A, I, g, D);
        return e.time(g, r, "html rewrite"), h;
      }
      function r(A) {
        const I = new Q.DV((_A, I) => I),
          g = new B.iX(I);
        return (
          g.write(A),
          g.end(),
          !(function A(I) {
            if ("attribs" in I)
              for (const A in I.attribs) {
                if ("scramjet-attr-script-source-src" === A) {
                  I.children[0] && "data" in I.children[0] && (I.children[0].data = atob(I.attribs[A]));
                  continue;
                }
                A.startsWith("scramjet-attr-") && ((I.attribs[A.slice(14)] = I.attribs[A]), delete I.attribs[A]);
              }
            if ("childNodes" in I) for (const g of I.childNodes) A(g);
          })(I.root),
    ...
    9381: (_A, I, g) => {
      g.d(I, { $n: () => i.$n, IP: () => i.IP, Oy: () => i.Oy, PV: () => C.PV, Qs: () => C.Qs, Uk: () => C.Uk, f9: () => B.f, gP: () => E.g, iP: () => o.i, lB: () => Q.l, n$: () => D.n$, nK: () => C.nK, nb: () => D.nb, on: () => E.o, sM: () => B.s, su: () => D.su, v2: () => i.v2 });
      var _B = g(2614),
        _Q = g(4435),
        _C = g(884),
        _E = g(1478),
      ...
      function E(A, I, g, B = !1) {
        return ((A, I, g, B) => {
          ...
          try {
            let i,
              o = performance.now();
            (i = "string" === typeof A ? E.rewrite_js(A, g.base.href, I || "(unknown)", B) : E.rewrite_js_bytes(A, g.base.href, I || "(unknown)", B)), C.time(g, o, `oxc rewrite for "${I || "(unknown)"}"`);
            const { js: D, map: t, scramtag: e, errors: s } = i;
            return { js: "string" === typeof A ? Q.su.decode(D) : D, tag: e, map: t, errors: s };
          } finally {
            i();
          }
        })(A, I, g, B);
      ...
      function i(A, I, g, C = !1) {
        try {
          ...
          if ((0, B.U5)("sourcemaps", g.base)) {
            const A = globalThis[B.$W.globals.pushsourcemapfn];
            if (A) A(Array.from(Q.map), Q.tag);
            else {
              i instanceof Uint8Array && (i = new TextDecoder().decode(i));
              const A = `${B.$W.globals.pushsourcemapfn}([${Q.map.join(",")}], "${Q.tag}");`,
                I = /^\s*(['"])use strict\1;?/;
              i = I.test(i)
                ? i.replace(
                    I,
...
${i}`;
          ...
          if ((0, B.U5)("rewriterLogs", g.base)) for (const A of Q.errors) console.error("oxc parse error", A);
          return i;
        } catch (C) {
          if ((console.warn("failed rewriting js for", I || "(unknown)", C.message, A instanceof Uint8Array ? Q.su.decode(A) : A), (0, B.U5)("allowInvalidJs", g.base))) return A;
          throw C;
        }
      }
    ...
    1472: (_A, I, g) => {
      ...
      function _E(A, I) {
        const g = new URL(A.substring(5));
        return `blob:${I.origin.origin}${g.pathname}`;
      }
      function i(A) {
        const I = new URL(A.substring(5));
        return `blob:${location.origin}${I.pathname}`;
      }
      function o(A, I) {
        if ((A instanceof URL && (A = A.toString()), A.startsWith("javascript:"))) return `javascript:${(0, Q.o)(A.slice(11), "(javascript: url)", I)}`;
        {
          if (A.startsWith("blob:") || A.startsWith("data:")) return location.origin + B.$W.prefix + A;
          if (A.startsWith("mailto:") || A.startsWith("about:")) return A;
          let g = I.base.href;
          g.startsWith("about:") && (g = D(self.location.href));
          const Q = C(A, g);
          if (!Q) return A;
          const E = (0, B.hD)(Q.hash.slice(1));
          return (Q.hash = ""), location.origin + B.$W.prefix + (0, B.hD)(Q.href) + (E ? `#${E}` : "");
        }
      }
      function D(A) {
        A instanceof URL && (A = A.toString());
    ...
    1561: (_A, I, g) => {
      ...
      function r(A) {
        let I;
        if (!(B instanceof Uint8Array)) throw Error("rewriter wasm not found (was it fetched correctly?)");
        if (![...B.slice(0, 4)].every((A, I) => A === a[I])) throw Error(`rewriter wasm does not have wasm magic (was it fetched correctly?)\nrewriter wasm contents: ${s.decode(B)}`);
        (0, Q.QR)({ module: new WebAssembly.Module(B) });
        const g = w.findIndex((A) => !A.inUse),
          e = w.length;
        return (
          -1 === g
            ? ((0, C.U5)("rewriterLogs", A.base) && console.log(`creating new rewriter, ${e} rewriters made already`),
              (I = {
                rewriter: new Q.LW({
                  config: C.$W,
                  shared: {
                    rewrite: {
                      ...
                      getHtmlInjectCode(A, I) {
                        const g = (0, t.Uk)(A, (A) => `<script src="${A}"></script>`).join("");
              ...
              w.push(I))
            : ((0, C.U5)("rewriterLogs", A.base) && console.log(`using cached rewriter ${g} from list of ${e} rewriters`), (I = w[g])),
          (I.inUse = !0),
...
`);
    ...
    6684: (_A, I, g) => {
      g.d(I, { Sn: () => s, YH: () => t, Yq: () => r, hU: () => e, pL: () => w, qp: () => a, rj: () => D });
      var B = g(6570);
      const Q = { none: 0, "same-origin": 1, "same-site": 2, "cross-site": 3 };
      async function C() {
      ...
      async function D(A, I, g) {
        (await E(A)) || (await i(A, { originalReferrer: I || "", mostRestrictiveSite: g, referrerPolicy: "", chainStarted: Date.now() }));
      }
      ...
      async function e(A, I) {
        const g = await E(A);
        if (!g) return I;
        const B = Q[g.mostRestrictiveSite];
        return (Q[I] ?? 0) > B ? ((g.mostRestrictiveSite = I), await i(A, g), I) : g.mostRestrictiveSite;
      }
      async function s(A) {
        await o(A);
      }
      async function a() {
        ...
        for await (const g of I.store) A - g.value.chainStarted > 36e5 && g.delete();
        await I.done;
      }
    ...
    2416: (_A, I, g) => {
      g.d(I, { Pg: () => Q.Pg, Sn: () => B.Sn, YH: () => B.YH, Yq: () => B.Yq, eI: () => Q.eI, hU: () => B.hU, pL: () => B.pL, ps: () => Q.ps, qp: () => B.qp, rj: () => B.rj });
      var _B = g(6684),
        _Q = g(8228);
    },
    8228: (_A, I, g) => {
      ...
      async function o(A, I, g) {
        return I ? (A.origin.origin === I.origin ? "same-origin" : (await D(A.origin, I, g)) ? "same-site" : "cross-site") : "none";
      }
      async function D(A, I, g) {
    ...
    2794: (_A, I, g) => {
      ...
      const B = "scramjet client global",
        _Q = Symbol.for(B),
        _C = Symbol.for("scramjet frame handle");
    },
    5956: (_A, I, g) => {
      function B(A, I) {
        const g = `
      ...
      function Q(A, I) {
        const g = { "content-type": "text/html" };
        return crossOriginIsolated && (g["Cross-Origin-Embedder-Policy"] = "require-corp"), new Response(B(String(A), I), { status: 500, headers: g });
      }
      g.d(I, { B: () => B, v: () => Q });
    },
    1403: (_A, I, g) => {
        ...
        constructor(A, I) {
          (this.handle = A),
            ...
            this.messageChannel.port1.addEventListener("message", (A) => {
              "scramjet$type" in A.data && ("init" === A.data.scramjet$type ? (this.connected = !0) : this.handleMessage(A.data));
            }),
            this.messageChannel.port1.start(),
            this.handle.postMessage({ scramjet$type: "init", scramjet$port: this.messageChannel.port2 }, [this.messageChannel.port2]);
        }
        handleMessage(A) {
          const I = this.promises[A.scramjet$token];
          I && (I(A), delete this.promises[A.scramjet$token]);
        }
        async fetch(A) {
          const I = this.syncToken++,
            g = { scramjet$type: "fetch", scramjet$token: I, scramjet$request: { url: A.url, body: A.body, headers: Array.from(A.headers.entries()), method: A.method, mode: A.mode, destinitation: A.destination } },
            B = A.body ? [A.body] : [];
          this.handle.postMessage(g, B);
          const { scramjet$response: Q } = await new Promise((A) => {
            this.promises[I] = A;
          });
          return !!Q && new Response(Q.body, { headers: Q.headers, status: Q.status, statusText: Q.statusText });
        }
      }
    },
    5790: (_A, I, g) => {
          ...
          if (i.pathname === this.config.files.wasm)
            return fetch(this.config.files.wasm).then(async (A) => {
              let I = await A.arrayBuffer(),
                g = btoa(new Uint8Array(I).reduce((A, I) => (A.push(String.fromCharCode(I)), A), []).join("")),
                B = "";
              return (
                (B += `if ('document' in self && document.currentScript) { document.currentScript.remove(); }
self.WASM = '${g}';`),
                new Response(B, { headers: { "content-type": "text/javascript" } })
              );
            });
          let t = "",
            e = {};
          for (const [A, I] of [...i.searchParams.entries()]) {
            switch (A) {
              case "type":
                t = I;
                break;
              ...
              case "parentFrame":
                ...
                break;
              default:
                w.warn(`${i.href} extraneous query parameter ${A}. Assuming <form> element`), (e[A] = I);
            }
            i.searchParams.delete(A);
          }
          const s = new URL((0, E.v2)(i));
          for (const [A, I] of Object.entries(e)) s.searchParams.set(A, I);
          const a = { origin: s, base: s, topFrameName: g, parentFrameName: B };
          if (i.pathname.startsWith(`${this.config.prefix}blob:`) || i.pathname.startsWith(`${this.config.prefix}data:`)) {
            let I,
              g = i.pathname.substring(this.config.prefix.length);
            g.startsWith("blob:") && (g = (0, E.$n)(g));
            const B = await fetch(g, {});
            (B.finalURL = g.startsWith("blob:") ? g : "(data url)"), B.body && (I = await S(B, a, A.destination, t, this.cookieStore));
            const Q = Object.fromEntries(B.headers.entries());
            return crossOriginIsolated && ((Q["Cross-Origin-Opener-Policy"] = "same-origin"), (Q["Cross-Origin-Embedder-Policy"] = "require-corp")), new Response(I, { status: B.status, statusText: B.statusText, headers: Q });
          }
          const r = this.serviceWorkers.find((A) => A.origin === s.origin);
          if (r?.connected && "swruntime" !== i.searchParams.get("from")) {
            const I = await r.fetch(A);
            if (I) return I;
          }
          if (s.origin === new URL(A.url).origin) throw Error("attempted to fetch from same origin - this means the site has obtained a reference to the real origin, aborting");
          const h = new o.u();
          for (const [I, g] of A.headers.entries()) h.set(I, g);
          if (I && new URL(I.url).pathname.startsWith(D.$W.prefix)) {
            const A = new URL((0, E.v2)(I.url));
            A.toString().includes("youtube.com") || (h.set("Referer", A.href), h.set("Origin", A.origin));
          }
          const G = this.cookieStore.getCookies(s, !1);
          G.length && h.set("Cookie", G);
          let N = !1;
          if ("iframe" === A.destination && "navigate" === A.mode && A.referrer && "no-referrer" !== A.referrer && A.referrer !== `${location.origin + D.$W.prefix}no-referrer`) {
            let I = A.referrer,
          ...
          N ? (h.set("Sec-Fetch-Dest", "document"), h.set("Sec-Fetch-Mode", "navigate")) : (h.set("Sec-Fetch-Dest", A.destination || "empty"), h.set("Sec-Fetch-Mode", A.mode));
          let n = "none";
          if (A.referrer && "" !== A.referrer && "no-referrer" !== A.referrer && A.referrer !== `${location.origin + D.$W.prefix}no-referrer` && A.referrer.includes(D.$W.prefix)) {
            const I = (0, E.v2)(A.referrer);
            if (I) {
              const A = new URL(I);
              n = await (0, Q.ps)(a, A, this.client);
            }
          }
          await (0, C.rj)(s.toString(), A.referrer ? (0, E.v2)(A.referrer) : null, n), h.set("Sec-Fetch-Site", await (0, C.hU)(s.toString(), n));
          const R = new y(s, h.headers, A.body, A.method, A.destination, I);
          this.dispatchEvent(R);
          const F = (await R.response) || (await this.client.fetch(R.url, { method: R.method, body: R.body, headers: R.requestHeaders, credentials: "omit", mode: "cors" === A.mode ? A.mode : "same-origin", cache: A.cache, redirect: "manual", duplex: "half" }));
          return (F.finalURL = R.url.href), await c(s, a, t, A.destination, A.mode, F, this.cookieStore, I, this.client, this, A.referrer);
        } catch (Q) {
          const I = { message: Q.message, url: A.url, destination: A.destination };
          if ((Q.stack && (I.stack = Q.stack), console.error("ERROR FROM SERVICE WORKER FETCH: ", I), console.error(Q), !["document", "iframe"].includes(A.destination))) return new Response(void 0, { status: 500 });
          const g = Object.entries(I)
      ...
      async function c(A, I, g, B, i, o, e, s, a, w, h) {
        ...
        if ((y && N["referrer-policy"] && h && (await (0, C.pL)(A.href, N["referrer-policy"], h)), r(o))) {
          const I = new URL((0, E.v2)(N.location));
          await (0, C.YH)(A.toString(), I.toString(), N["referrer-policy"]);
          const B = await (0, Q.ps)({ origin: I, base: I }, A, a);
          if ((await (0, C.hU)(I.toString(), B), g)) {
            const A = new URL(N.location);
            A.searchParams.set("type", g), (N.location = A.href);
          }
        }
        const n = N["set-cookie"] || [];
        for (const I in n)
          if (s) {
            const g = w.dispatch(s, { scramjet$type: "cookie", cookie: I, url: A.href });
            "document" !== B && "iframe" !== B && (await g);
          }
        for (const I in (await e.setCookies(Array.isArray(n) ? n : [n], A), N)) Array.isArray(N[I]) && (N[I] = N[I][0]);
        if (
          ((A, I) => {
            if (["document", "iframe"].includes(I)) {
              ...
              if (I) {
                ...
                const I = A["content-type"]?.split(";")[0].trim().toLowerCase();
                if (I && !["text/html", "text/plain", "text/css", "text/javascript", "text/xml", "application/javascript", "application/json", "application/xml", "application/pdf"].includes(I) && !I.startsWith("text") && !I.startsWith("image") && !I.startsWith("font") && !I.startsWith("video")) return !0;
              }
            }
            return !1;
          })(N, B) &&
          ...
          if ((0, D.U5)("interceptDownloads", A)) {
            ...
            if ("string" === typeof g) {
              const A = g.match(/filename=["']?([^"';\n]*)["']?/i);
              A?.[1] && (I = A[1]);
            }
            let B = N["content-length"],
              Q = await clients.matchAll({});
            if ((Q = Q.filter((A) => !A.url.includes(D.$W.prefix))).length < 1) throw Error("couldn't find a controller client to dispatch download to");
            const C = { filename: I, url: A.href, type: N["content-type"], body: o.body, length: Number(B) };
            Q[0].postMessage({ scramjet$type: "download", download: C }, [o.body]), await new Promise(() => {});
          } else {
            const A = N["content-disposition"];
            if (!/\s*?((inline|attachment);\s*?)filename=/i.test(A)) {
              const I = /^\s*?attachment/i.test(A) ? "attachment" : "inline",
        ...
        o.body && !r(o) && (c = await S(o, I, B, g, e)),
          ...
          crossOriginIsolated && ["document", "iframe", "worker", "sharedworker", "style", "script"].includes(B) && ((N["Cross-Origin-Embedder-Policy"] = "require-corp"), (N["Cross-Origin-Opener-Policy"] = "same-origin"));
        const R = new G(c, N, o.status, o.statusText, B, A, o, s);
        return w.dispatchEvent(R), r(o) || (await (0, C.Sn)(A.toString())), new Response(R.responseBody, { headers: R.responseHeaders, status: R.status, statusText: R.statusText });
      }
      async function S(A, I, g, B, Q) {
        switch (g) {
          case "iframe":
          case "document":
            if (A.headers.get("content-type")?.startsWith("text/html")) return (0, e.Qs)(await A.text(), Q, I, !0);
            return A.body;
          case "script":
      ...
      class G extends Event {
        ...
        constructor(A, I, g, B, Q, C, E, i) {
          super("handleResponse"), (this.responseBody = A), (this.responseHeaders = I), (this.status = g), (this.statusText = B), (this.destination = Q), (this.url = C), (this.rawResponse = E), (this.client = i);
        }
      }
      class y extends Event {
        ...
        constructor(A, I, g, B, Q, C) {
          super("request"), (this.url = A), (this.requestHeaders = I), (this.body = g), (this.method = B), (this.destination = Q), (this.client = C);
        }
        response;
      }
    },
    7510: (_A, I, g) => {
      g.r(I), g.d(I, { FakeServiceWorker: () => B.H, ScramjetHandleResponseEvent: () => Q.dT, ScramjetRequestEvent: () => Q.V3, ScramjetServiceWorker: () => e, errorTemplate: () => t.B, handleFetch: () => Q.Pf, renderError: () => t.v });
      var B = g(1403),
        Q = g(5790),
        C = g(236),
        E = g(1561),
      ...
      class e extends EventTarget {
        ...
        constructor() {
          super(),
            ...
            (async () => {
              const A = await (0, o.P2)("$scramjet", 1),
            ...
            addEventListener("message", async ({ data: A }) => {
              if ("scramjet$type" in A) {
                if ("scramjet$token" in A) {
                  const I = this.syncPool[A.scramjet$token];
                  delete this.syncPool[A.scramjet$token], I(A);
                  return;
                }
                if ("registerServiceWorker" === A.scramjet$type) return void this.serviceWorkers.push(new B.H(A.port, A.origin));
                if ("cookie" === A.scramjet$type) {
                  this.cookieStore.setCookies([A.cookie], new URL(A.url));
                  const I = await (0, o.P2)("$scramjet", 1);
        ...
        async loadConfig() {
          ...
          const A = await (0, o.P2)("$scramjet", 1);
          (this.config = await A.get("config", "config")), this.config && ((0, D.Nk)(this.config), await (0, E.n$)());
        }
        route({ request: A }) {
          return !!A.url.startsWith(location.origin + this.config.prefix) || !!A.url.startsWith(location.origin + this.config.files.wasm);
        }
        async fetch({ request: A, clientId: I }) {
          this.config || (await this.loadConfig());
          const g = await self.clients.get(I);
    ...
    236: (_A, I, g) => {
      ...
      const B = globalThis.fetch,
        ...
        o = { prototype: { send: WebSocket.prototype.send }, CLOSED: WebSocket.CLOSED, CLOSING: WebSocket.CLOSING, CONNECTING: WebSocket.CONNECTING, OPEN: WebSocket.OPEN };
      async function D() {
        const A = Promise.race([
          Promise.any(
            (await self.clients.matchAll({ type: "window", includeUncontrolled: !0 })).map(async (A) => {
              let I,
          ...
          new Promise((_A, I) => setTimeout(I, 1e3, TypeError("timeout"))),
        ]);
        try {
          return await A;
        } catch (A) {
          if (A instanceof AggregateError) throw (console.error("bare-mux: failed to get a bare-mux SharedWorker MessagePort as all clients returned an invalid MessagePort."), Error("All clients returned an invalid MessagePort."));
          return console.warn("bare-mux: failed to get a bare-mux SharedWorker MessagePort within 1s, retrying"), await D();
        }
      }
      function t(A) {
      ...
      function e(A, I) {
        const g = new Q(A, "bare-mux-worker");
        return (
          I &&
      ...
      class a {
        constructor(A) {
          (this.channel = new BroadcastChannel("bare-mux")), A instanceof MessagePort || A instanceof Promise ? (this.port = A) : this.createChannel(A, !0);
        }
        createChannel(A, I) {
          if (self.clients)
            (this.port = D()),
            ...
            if (!A.startsWith("/") && !A.includes("://")) throw Error("Invalid URL. Must be absolute or start at the root.");
            (this.port = e(A, I)), console.debug("bare-mux: setting localStorage bare-mux-path to", A), (C["bare-mux-path"] = A);
          } else {
            if (!SharedWorker) throw Error("Unable to get a channel to the SharedWorker.");
            {
              const A = C["bare-mux-path"];
              if ((console.debug("bare-mux: got localStorage bare-mux-path:", A), !A)) throw Error("Unable to get bare-mux workerPath from localStorage.");
              this.port = e(A, I);
            }
          }
        }
        async sendMessage(A, I) {
          ...
          try {
            ...
            return console.warn("bare-mux: Failed to get a ping response from the worker within 1.5s. Assuming port is dead."), this.createChannel(), await this.sendMessage(A, I);
          }
      ...
      class w extends EventTarget {
        constructor(A, I = [], g, B) {
          super(), (this.protocols = I), (this.readyState = o.CONNECTING), (this.url = A.toString()), (this.protocols = I);
          const Q = (A) => {
            ...
            C = async (A) => {
              const I = new MessageEvent("message", { data: A });
              this.dispatchEvent(I);
            },
            E = (A, I) => {
              this.readyState = o.CLOSED;
              const g = new CloseEvent("close", { code: A, reason: I });
          ...
          (this.channel = new MessageChannel()),
            (this.channel.port1.onmessage = (A) => {
              "open" === A.data.type ? Q(A.data.args[0]) : "message" === A.data.type ? C(A.data.args[0]) : "close" === A.data.type ? E(A.data.args[0], A.data.args[1]) : "error" === A.data.type && i();
            }),
            g.sendMessage({ type: "websocket", websocket: { url: A.toString(), protocols: I, requestHeaders: B, channel: this.channel.port2 } }, [this.channel.port2]);
        }
        send(...A) {
          if (this.readyState === o.CONNECTING) throw new DOMException("Failed to execute 'send' on 'WebSocket': Still in CONNECTING state.");
          let I = A[0];
          I.buffer && (I = I.buffer.slice(I.byteOffset, I.byteOffset + I.byteLength)), i.call(this.channel.port1, { type: "data", data: I }, I instanceof ArrayBuffer ? [I] : []);
        }
        close(A, I) {
          i.call(this.channel.port1, { type: "close", closeCode: A, closeReason: I });
        }
      }
      function r(A, I, g) {
        console.error(`error while processing '${g}': `, I), A.postMessage({ type: "error", error: I });
      }
      const h = ["ws:", "wss:"],
        c = [101, 204, 205, 304],
      ...
      class G {
        ...
        async setRemoteTransport(A, I) {
          ...
          (g.port1.onmessage = async (I) => {
            ...
            if ("fetch" === B.type)
              try {
                A.ready || (await A.init()),
                  await (async (A, I, g) => {
                    const B = await g.request(new URL(A.fetch.remote), A.fetch.method, A.fetch.body, A.fetch.headers, null);
                    if (
                      !(() => {
                        if (null === s) {
                          let A,
                      ...
                      const A = new Response(B.body);
                      B.body = await A.arrayBuffer();
                    }
                    B.body instanceof ReadableStream || B.body instanceof ArrayBuffer ? i.call(I, { type: "fetch", fetch: B }, [B.body]) : i.call(I, { type: "fetch", fetch: B });
                  })(B, g, A);
              } catch (A) {
                r(g, A, "fetch");
              }
                ...
                A.ready || (await A.init()),
                  await (async (A, I, g) => {
                    const [B, Q] = g.connect(
                      ...
                      (I) => {
                        i.call(A.websocket.channel, { type: "open", args: [I] });
                      },
                      (I) => {
                        I instanceof ArrayBuffer ? i.call(A.websocket.channel, { type: "message", args: [I] }, [I]) : i.call(A.websocket.channel, { type: "message", args: [I] });
                      },
                      (I, g) => {
                        i.call(A.websocket.channel, { type: "close", args: [I, g] });
                      },
                      (I) => {
                        i.call(A.websocket.channel, { type: "error", args: [I] });
                      },
                    );
                    (A.websocket.channel.onmessage = (A) => {
                      "data" === A.data.type ? B(A.data.data) : "close" === A.data.type && Q(A.data.closeCode, A.data.closeReason);
                    }),
            ...
            await this.worker.sendMessage({ type: "set", client: { function: "bare-mux-remote", args: [g.port2, I] } }, [g.port2]);
        }
        getInnerPort() {
      ...
      class y {
        ...
        createWebSocket(A, I = [], _g, B) {
          try {
            A = new URL(A);
          } catch (_I) {
            throw new DOMException(`Faiiled to construct 'WebSocket': The URL '${A}' is invalid.`);
          }
          if (!h.includes(A.protocol)) throw new DOMException(`Failed to construct 'WebSocket': The URL's scheme must be either 'ws' or 'wss'. '${A.protocol}' is not allowed.`);
          for (const A of (Array.isArray(I) || (I = [I]), (I = I.map(String))))
            if (
              !((A) => {
                for (let I = 0; I < A.length; I++) {
                  const g = A[I];
                  if (!"!#$%&'*+-.0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ^_`abcdefghijklmnopqrstuvwxyz|~".includes(g)) return !1;
                }
                return !0;
              })(A)
            )
        ...
        async fetch(A, I) {
          ...
          for (let A = 0; ; A++) {
            const B = (await this.worker.sendMessage({ type: "fetch", fetch: { remote: i.toString(), method: g.method, headers: C, body: E || void 0 } }, E ? [E] : [])).fetch,
              Q = new Response(c.includes(B.status) ? void 0 : B.body, { headers: new Headers(B.headers), status: B.status, statusText: B.statusText });
            (Q.rawHeaders = B.headers), (Q.rawResponse = B), (Q.finalURL = i.toString());
            const o = I?.redirect || g.redirect;
            if (!S.includes(Q.status)) return Q;
            switch (o) {
              case "follow": {
                const I = Q.headers.get("location");
                if (20 > A && null !== I) {
                  i = new URL(I, i);
                  continue;
                }
    ...
    6498: (_A, I, g) => {
      ...
      var B = g(2743),
        Q = g(8466),
        C = g(8832);
      const E = new Set(["style", "script", "xmp", "iframe", "noembed", "noframes", "plaintext", "noscript"]);
      function i(A) {
        return A.replace(/"/g, "&quot;");
      }
      const o = new Set(["area", "base", "basefont", "br", "col", "command", "embed", "frame", "hr", "img", "input", "isindex", "keygen", "link", "meta", "param", "source", "track", "wbr"]),
        D = function A(I, g = {}) {
            ...
            s += ((I, g) => {
              ...
              switch (I.type) {
                ...
                case B.vw:
                  return ((I, g) => {
                    var B;
                    "foreign" === g.xmlMode && ((I.name = null != (B = C.H.get(I.name)) ? B : I.name), I.parent && t.has(I.parent.name) && (g = { ...g, xmlMode: !1 })), !g.xmlMode && e.has(I.name) && (g = { ...g, xmlMode: "foreign" });
                    let E = `<${I.name}`,
                      D = ((A, I) => {
                        var g;
                        if (!A) return;
                        const B = (null != (g = I.encodeEntities) ? g : I.decodeEntities) === !1 ? i : I.xmlMode || "utf8" !== I.encodeEntities ? Q.WY : Q.Gj;
                        return Object.keys(A)
                          .map((g) => {
                            var Q, E;
                            const i = null != (Q = A[g]) ? Q : "";
                            return ("foreign" === I.xmlMode && (g = null != (E = C.L.get(g)) ? E : g), I.emptyAttrs || I.xmlMode || "" !== i) ? `${g}="${B(i)}"` : g;
                          })
                          .join(" ");
                      })(I.attribs, g);
                    return D && (E += ` ${D}`), 0 === I.children.length && (g.xmlMode ? !1 !== g.selfClosingTags : g.selfClosingTags && o.has(I.name)) ? (g.xmlMode || (E += " "), (E += "/>")) : ((E += ">"), I.children.length > 0 && (E += A(I.children, g)), (g.xmlMode || !o.has(I.name)) && (E += `</${I.name}>`)), E;
                  })(I, g);
                case B.EY:
                  return ((A, I) => {
                    var g;
                    let B = A.data || "";
                    return (null != (g = I.encodeEntities) ? g : I.decodeEntities) === !1 || (!I.xmlMode && A.parent && E.has(A.parent.name)) || (B = I.xmlMode || "utf8" !== I.encodeEntities ? (0, Q.WY)(B) : (0, Q.X1)(B)), B;
                  })(I, g);
              }
            })(D[I], g);
          return s;
        },
        t = new Set(["mi", "mo", "mn", "ms", "mtext", "annotation-xml", "foreignObject", "desc", "title"]),
        e = new Set(["svg", "math"]);
    },
    2743: (_A, I, g) => {
      var B, Q;
      ...
      g.d(I, { EY: () => i, KB: () => a, Mw: () => D, OF: () => e, RJ: () => B, WL: () => o, bL: () => E, dz: () => C, eF: () => t, fl: () => w, vw: () => s }),
        ((Q = B || (B = {})).Root = "root"),
        (Q.Text = "text"),
    ...
    8866: (_A, I, g) => {
      ...
      var B = g(2743),
        Q = g(6072);
      const C = { withStartIndices: !1, withEndIndices: !1, xmlMode: !1 };
      class E {
        constructor(A, I, g) {
          (this.dom = []),
        ...
        onreset() {
          (this.dom = []), (this.root = new Q.yo(this.dom)), (this.done = !1), (this.tagStack = [this.root]), (this.lastNode = null), (this.parser = null);
        }
        onend() {
        ...
        onclosetag() {
          ...
          this.options.withEndIndices && (A.endIndex = this.parser.endIndex), this.elementCB?.(A);
        }
        onopentag(A, I) {
          const g = this.options.xmlMode ? B.RJ.Tag : void 0,
            C = new Q.Hg(A, I, void 0, g);
          this.addNode(C), this.tagStack.push(C);
        }
        ontext(A) {
          const { lastNode: I } = this;
          if (I && I.type === B.RJ.Text) (I.data += A), this.options.withEndIndices && (I.endIndex = this.parser.endIndex);
          else {
            const I = new Q.EY(A);
        ...
        addNode(A) {
          const I = this.tagStack[this.tagStack.length - 1],
            g = I.children[I.children.length - 1];
          this.options.withStartIndices && (A.startIndex = this.parser.startIndex), this.options.withEndIndices && (A.endIndex = this.parser.endIndex), I.children.push(A), g && ((A.prev = g), (g.next = A)), (A.parent = I), (this.lastNode = null);
        }
      }
    },
    6072: (_A, I, g) => {
      g.d(I, { Cd: () => o, EY: () => E, Hg: () => s, KB: () => t, Mw: () => i, yo: () => e });
      var B = g(2743);
      class Q {
        constructor() {
      ...
      class s extends D {
        constructor(A, I, g = [], Q = "script" === A ? B.RJ.Script : "style" === A ? B.RJ.Style : B.RJ.Tag) {
        ...
        get attributes() {
          return Object.keys(this.attribs).map((A) => {
            var I, g;
            return { name: A, value: this.attribs[A], namespace: null == (I = this["x-attribsNamespace"]) ? void 0 : I[A], prefix: null == (g = this["x-attribsPrefix"]) ? void 0 : g[A] };
          });
        }
      }
      function a(A, I = !1) {
        ...
        if (A.type === B.RJ.Text) g = new E(A.data);
          ...
          const B = I ? w(A.children) : [],
            Q = new s(A.name, { ...A.attribs }, B);
          B.forEach((A) => (A.parent = Q)), null != A.namespace && (Q.namespace = A.namespace), A["x-attribsNamespace"] && (Q["x-attribsNamespace"] = { ...A["x-attribsNamespace"] }), A["x-attribsPrefix"] && (Q["x-attribsPrefix"] = { ...A["x-attribsPrefix"] }), (g = Q);
          ...
          const I = new o(A.name, A.data);
          null != A["x-name"] && ((I["x-name"] = A["x-name"]), (I["x-publicId"] = A["x-publicId"]), (I["x-systemId"] = A["x-systemId"])), (g = I);
        } else throw Error(`Not implemented yet: ${A.type}`);
        return (g.startIndex = A.startIndex), (g.endIndex = A.endIndex), null != A.sourceCodeLocation && (g.sourceCodeLocation = A.sourceCodeLocation), g;
      }
      function w(A) {
        const I = A.map((A) => a(A, !0));
    ...
    6812: (_A, _I, g) => {
      var B, Q;
      g(8866), ((Q = B || (B = {}))[(Q.DISCONNECTED = 1)] = "DISCONNECTED"), (Q[(Q.PRECEDING = 2)] = "PRECEDING"), (Q[(Q.FOLLOWING = 4)] = "FOLLOWING"), (Q[(Q.CONTAINS = 8)] = "CONTAINS"), (Q[(Q.CONTAINED_BY = 16)] = "CONTAINED_BY");
    },
    4993: (_A, _I, g) => {
      ...
      const Q = new Map([
        ...
        _C =
          null != (B = String.fromCodePoint)
            ...
            : (A) => {
                let I = "";
                return A > 65535 && ((A -= 65536), (I += String.fromCharCode(((A >>> 10) & 1023) | 55296)), (A = 56320 | (1023 & A))), (I += String.fromCharCode(A));
              };
      function _E(A) {
        var I;
    ...
    2990: (_A, I, g) => {
      g.d(I, { FJ: () => t, MK: () => a.MK, Wf: () => r, qN: () => e.q, sr: () => s.s });
      var B,
        Q,
        C,
        E,
      ...
      class r {
        constructor(A, I, g) {
          (this.decodeTree = A), (this.emitCodePoint = I), (this.errors = g), (this.state = D.EntityStart), (this.consumed = 1), (this.result = 0), (this.treeIndex = 0), (this.excess = 1), (this.decodeMode = t.Strict);
        }
        startEntity(A) {
          (this.decodeMode = A), (this.state = D.EntityStart), (this.result = 0), (this.treeIndex = 0), (this.excess = 1), (this.consumed = 1);
        }
        write(A, I) {
          switch (this.state) {
            case D.EntityStart:
              if (A.charCodeAt(I) === i.NUM) return (this.state = D.NumericStart), (this.consumed += 1), this.stateNumericStart(A, I + 1);
        ...
        stateNumericStart(A, I) {
          return I >= A.length ? -1 : (32 | A.charCodeAt(I)) === i.LOWER_X ? ((this.state = D.NumericHex), (this.consumed += 1), this.stateNumericHex(A, I + 1)) : ((this.state = D.NumericDecimal), this.stateNumericDecimal(A, I));
        }
        addToNumericResult(A, I, g, B) {
          if (I !== g) {
            const Q = g - I;
            (this.result = this.result * B ** Q + Number.parseInt(A.substr(I, Q), B)), (this.consumed += Q);
          }
        }
        stateNumericHex(A, I) {
          const g = I;
          for (; I < A.length; ) {
            ...
            if (!w(Q) && (!((B = Q) >= i.UPPER_A) || !(B <= i.UPPER_F)) && (!(B >= i.LOWER_A) || !(B <= i.LOWER_F))) return this.addToNumericResult(A, g, I, 16), this.emitNumericEntity(Q, 3);
            I += 1;
          }
        ...
        emitNumericEntity(A, I) {
          var g;
          if (this.consumed <= I) return null == (g = this.errors) || g.absenceOfDigitsInNumericCharacterReference(this.consumed), 0;
          if (A === i.SEMI) this.consumed += 1;
          else if (this.decodeMode === t.Strict) return 0;
          return this.emitCodePoint((0, a.y6)(this.result), this.consumed), this.errors && (A !== i.SEMI && this.errors.missingSemicolonAfterCharacterReference(), this.errors.validateNumericCharacterReference(this.result)), this.consumed;
        }
        stateNamedEntity(A, I) {
          ...
          for (; I < A.length; I++, this.excess++) {
            ...
            if (
              ((this.treeIndex = ((A, I, g, B) => {
                const Q = (I & o.BRANCH_LENGTH) >> 7,
                  C = I & o.JUMP_TABLE;
              ...
              return 0 === this.result ||
                (this.decodeMode === t.Attribute &&
                  (0 === Q ||
                    ((A) => {
                      var I;
                      return A === i.EQUALS || ((I = A) >= i.UPPER_A && I <= i.UPPER_Z) || (I >= i.LOWER_A && I <= i.LOWER_Z) || w(I);
                    })(C)))
                ? 0
                : this.emitNotTerminatedNamedEntity();
            if (0 !== (Q = ((B = g[this.treeIndex]) & o.VALUE_LENGTH) >> 14)) {
              if (C === i.SEMI) return this.emitNamedEntityData(this.treeIndex, Q, this.consumed + this.excess);
        ...
        emitNotTerminatedNamedEntity() {
          var A;
          const { result: I, decodeTree: g } = this,
            B = (g[I] & o.VALUE_LENGTH) >> 14;
          return this.emitNamedEntityData(I, B, this.consumed), null == (A = this.errors) || A.missingSemicolonAfterCharacterReference(), this.consumed;
        }
        emitNamedEntityData(A, I, g) {
          const { decodeTree: B } = this;
          return this.emitCodePoint(1 === I ? B[A] & ~o.VALUE_LENGTH : B[A + 1], g), 3 === I && this.emitCodePoint(B[A + 2], g), g;
        }
        end() {
          var A;
          switch (this.state) {
            case D.NamedEntity:
              return 0 !== this.result && (this.decodeMode !== t.Attribute || this.result === this.treeIndex) ? this.emitNotTerminatedNamedEntity() : 0;
            case D.NumericDecimal:
              return this.emitNumericEntity(0, 2);
            case D.NumericHex:
              return this.emitNumericEntity(0, 3);
            case D.NumericStart:
              return null == (A = this.errors) || A.absenceOfDigitsInNumericCharacterReference(this.consumed), 0;
            case D.EntityStart:
              return 0;
          }
        }
    ...
    747: (_A, I, g) => {
      ...
      const B = /["$&'<>\u0080-\uFFFF]/g,
        ...
        C = null == String.prototype.codePointAt ? (A, I) => ((64512 & A.charCodeAt(I)) === 55296 ? (A.charCodeAt(I) - 55296) * 1024 + A.charCodeAt(I + 1) - 56320 + 65536 : A.charCodeAt(I)) : (A, I) => A.codePointAt(I);
      function _E(A) {
        let I,
          g = "",
          E = 0;
        for (; null !== (I = B.exec(A)); ) {
          const { index: i } = I,
            o = A.charCodeAt(i),
            D = Q.get(o);
          void 0 === D ? ((g += `${A.substring(E, i)}&#x${C(A, i).toString(16)};`), (E = B.lastIndex += Number((64512 & o) === 55296))) : ((g += A.substring(E, i) + D), (E = i + 1));
        }
        return g + A.substr(E);
      }
      function i(A, I) {
        return (g) => {
          let B,
            Q = 0,
            C = "";
          for (; (B = A.exec(g)); ) Q !== B.index && (C += g.substring(Q, B.index)), (C += I.get(B[0].charCodeAt(0))), (Q = B.index + 1);
    ...
    5949: (_A, I, g) => {
      g.d(I, { s: () => B });
      const _B = new Uint16Array("Ȁaglq	\x15\x18\x1bɭ\x0f\0\0\x12p;䀦os;䀧t;䀾t;䀼uot;䀢".split("").map((A) => A.charCodeAt(0)));
    },
    9496: () => {},
    8466: (_A, I, g) => {
      ...
      var B,
        ...
        E,
        i = g(747);
      ((B = C || (C = {}))[(B.XML = 0)] = "XML"), (B[(B.HTML = 1)] = "HTML"), ((Q = E || (E = {}))[(Q.UTF8 = 0)] = "UTF8"), (Q[(Q.ASCII = 1)] = "ASCII"), (Q[(Q.Extensive = 2)] = "Extensive"), (Q[(Q.Attribute = 3)] = "Attribute"), (Q[(Q.Text = 4)] = "Text");
    },
    4645: (_A, I, g) => {
      g.d(I, { i: () => r });
      var B = g(5645),
        Q = g(2990);
      const C = new Set(["input", "option", "optgroup", "select", "button", "datalist", "textarea"]),
        E = new Set(["p"]),
        ...
        e = new Set(["area", "base", "basefont", "br", "col", "command", "embed", "frame", "hr", "img", "input", "isindex", "keygen", "link", "meta", "param", "source", "track", "wbr"]),
        s = new Set(["math", "svg"]),
      ...
      class r {
        constructor(A, I = {}) {
          ...
          (this.options = I),
            ...
            (this.lowerCaseAttributeNames = null != (Q = I.lowerCaseAttributeNames) ? Q : this.htmlMode),
        ...
        ontext(A, I) {
          var g, B;
          const Q = this.getSlice(A, I);
          (this.endIndex = I - 1), null == (B = (g = this.cbs).ontext) || B.call(g, Q), (this.startIndex = I);
        }
        ontextentity(A, I) {
          var g, B;
          (this.endIndex = I - 1), null == (B = (g = this.cbs).ontext) || B.call(g, (0, Q.MK)(A)), (this.startIndex = I);
        }
        isVoidElement(A) {
        ...
        emitOpenTag(A) {
          ...
          const C = this.htmlMode && t.get(A);
          if (C)
            for (; this.stack.length > 0 && C.has(this.stack[0]); ) {
              const A = this.stack.shift();
              null == (g = (I = this.cbs).onclosetag) || g.call(I, A, !0);
            }
          !this.isVoidElement(A) && (this.stack.unshift(A), this.htmlMode && (s.has(A) ? this.foreignContext.unshift(!0) : a.has(A) && this.foreignContext.unshift(!1))), null == (Q = (B = this.cbs).onopentagname) || Q.call(B, A), this.cbs.onopentag && (this.attribs = {});
        }
        endOpenTag(A) {
          var I, g;
          (this.startIndex = this.openTagStart), this.attribs && (null == (g = (I = this.cbs).onopentag) || g.call(I, this.tagname, this.attribs, A), (this.attribs = null)), this.cbs.onclosetag && this.isVoidElement(this.tagname) && this.cbs.onclosetag(this.tagname, !0), (this.tagname = "");
        }
        onopentagend(A) {
        ...
        onclosetag(A, I) {
          ...
          if ((this.lowerCaseTagNames && (t = t.toLowerCase()), this.htmlMode && (s.has(t) || a.has(t)) && this.foreignContext.shift(), this.isVoidElement(t)))
            this.htmlMode && "br" === t && (null == (C = (Q = this.cbs).onopentagname) || C.call(Q, "br"), null == (i = (E = this.cbs).onopentag) || i.call(E, "br", {}, !0), null == (D = (o = this.cbs).onclosetag) || D.call(o, "br", !1));
          else {
            const A = this.stack.indexOf(t);
            if (-1 !== A)
              for (let I = 0; I <= A; I++) {
                const Q = this.stack.shift();
        ...
        onselfclosingtag(A) {
          (this.endIndex = A), this.recognizeSelfClosing || this.foreignContext[0] ? (this.closeCurrentTag(!1), (this.startIndex = A + 1)) : this.onopentagend(A);
        }
        closeCurrentTag(A) {
          var I, g;
          const B = this.tagname;
          this.endOpenTag(A), this.stack[0] === B && (null == (g = (I = this.cbs).onclosetag) || g.call(I, B, !A), this.stack.shift());
        }
        onattribname(A, I) {
          this.startIndex = A;
          const g = this.getSlice(A, I);
        ...
        onattribend(A, I) {
          var g, Q;
          (this.endIndex = I),
            null == (Q = (g = this.cbs).onattribute) || Q.call(g, this.attribname, this.attribvalue, A === B.X.Double ? '"' : A === B.X.Single ? "'" : A === B.X.NoValue ? void 0 : null),
        ...
        ondeclaration(A, I) {
          ...
          if (this.cbs.onprocessinginstruction) {
            const A = this.getInstructionName(g);
        ...
        oncomment(A, I, g) {
          var B, Q, C, E;
          (this.endIndex = I), null == (Q = (B = this.cbs).oncomment) || Q.call(B, this.getSlice(A, I - g)), null == (E = (C = this.cbs).oncommentend) || E.call(C), (this.startIndex = I + 1);
        }
        oncdata(A, I, g) {
          var B, Q, C, E, i, o, D, t, e, s;
          this.endIndex = I;
          const a = this.getSlice(A, I - g);
          !this.htmlMode || this.options.recognizeCDATA
            ? (null == (Q = (B = this.cbs).oncdatastart) || Q.call(B), null == (E = (C = this.cbs).ontext) || E.call(C, a), null == (o = (i = this.cbs).oncdataend) || o.call(i))
            : (null == (t = (D = this.cbs).oncomment) || t.call(D, `[CDATA[${a}]]`), null == (s = (e = this.cbs).oncommentend) || s.call(e)),
            (this.startIndex = I + 1);
        }
        onend() {
          var A, I;
        ...
        getSlice(A, I) {
          ...
          for (; I - this.bufferOffset > this.buffers[0].length; ) this.shiftBuffer(), (g += this.buffers[0].slice(0, I - this.bufferOffset));
          return g;
        }
        shiftBuffer() {
    ...
    5645: (_A, I, g) => {
      ...
      var B,
        ...
        D = g(2990);
      function t(A) {
        return A === E.Space || A === E.NewLine || A === E.Tab || A === E.FormFeed || A === E.CarriageReturn;
      }
      function e(A) {
      ...
      class a {
        ...
        stateText(A) {
          A === E.Lt || (!this.decodeEntities && this.fastForwardTo(E.Lt)) ? (this.index > this.sectionStart && this.cbs.ontext(this.sectionStart, this.index), (this.state = i.BeforeTagName), (this.sectionStart = this.index)) : this.decodeEntities && A === E.Amp && this.startEntity();
        }
        ...
        stateInSpecialTag(A) {
          ...
          (32 | A) === this.currentSequence[this.sequenceIndex] ? (this.sequenceIndex += 1) : 0 === this.sequenceIndex ? (this.currentSequence === s.TitleEnd ? this.decodeEntities && A === E.Amp && this.startEntity() : this.fastForwardTo(E.Lt) && (this.sequenceIndex = 1)) : (this.sequenceIndex = Number(A === E.Lt));
        }
        stateCDATASequence(A) {
          A === s.Cdata[this.sequenceIndex] ? ++this.sequenceIndex === s.Cdata.length && ((this.state = i.InCommentLike), (this.currentSequence = s.CdataEnd), (this.sequenceIndex = 0), (this.sectionStart = this.index + 1)) : ((this.sequenceIndex = 0), (this.state = i.InDeclaration), this.stateInDeclaration(A));
        }
        fastForwardTo(A) {
          for (; ++this.index < this.buffer.length + this.offset; ) if (this.buffer.charCodeAt(this.index - this.offset) === A) return !0;
          return (this.index = this.buffer.length + this.offset - 1), !1;
        }
        stateInCommentLike(A) {
          A === this.currentSequence[this.sequenceIndex]
            ? ++this.sequenceIndex === this.currentSequence.length && (this.currentSequence === s.CdataEnd ? this.cbs.oncdata(this.sectionStart, this.index, 2) : this.cbs.oncomment(this.sectionStart, this.index, 2), (this.sequenceIndex = 0), (this.sectionStart = this.index + 1), (this.state = i.Text))
        ...
        isTagStartChar(A) {
          return this.xmlMode ? !e(A) : (A >= E.LowerA && A <= E.LowerZ) || (A >= E.UpperA && A <= E.UpperZ);
        }
        startSpecial(A, I) {
          (this.isSpecial = !0), (this.currentSequence = A), (this.sequenceIndex = I), (this.state = i.SpecialStartSequence);
        }
        stateBeforeTagName(A) {
          if (A === E.ExclamationMark) (this.state = i.BeforeDeclaration), (this.sectionStart = this.index + 1);
          else if (A === E.Questionmark) (this.state = i.InProcessingInstruction), (this.sectionStart = this.index + 1);
          else if (this.isTagStartChar(A)) {
            const I = 32 | A;
            (this.sectionStart = this.index), this.xmlMode ? (this.state = i.InTagName) : I === s.ScriptEnd[2] ? (this.state = i.BeforeSpecialS) : I === s.TitleEnd[2] || I === s.XmpEnd[2] ? (this.state = i.BeforeSpecialT) : (this.state = i.InTagName);
          } else A === E.Slash ? (this.state = i.BeforeClosingTagName) : ((this.state = i.Text), this.stateText(A));
        }
        stateInTagName(A) {
          e(A) && (this.cbs.onopentagname(this.sectionStart, this.index), (this.sectionStart = -1), (this.state = i.BeforeAttributeName), this.stateBeforeAttributeName(A));
        }
        stateBeforeClosingTagName(A) {
          t(A) || (A === E.Gt ? (this.state = i.Text) : ((this.state = this.isTagStartChar(A) ? i.InClosingTagName : i.InSpecialComment), (this.sectionStart = this.index)));
        }
        stateInClosingTagName(A) {
          (A === E.Gt || t(A)) && (this.cbs.onclosetag(this.sectionStart, this.index), (this.sectionStart = -1), (this.state = i.AfterClosingTagName), this.stateAfterClosingTagName(A));
        }
        stateAfterClosingTagName(A) {
          (A === E.Gt || this.fastForwardTo(E.Gt)) && ((this.state = i.Text), (this.sectionStart = this.index + 1));
        }
        stateBeforeAttributeName(A) {
          A === E.Gt
            ? (this.cbs.onopentagend(this.index), this.isSpecial ? ((this.state = i.InSpecialTag), (this.sequenceIndex = 0)) : (this.state = i.Text), (this.sectionStart = this.index + 1))
            : A === E.Slash
              ? (this.state = i.InSelfClosingTag)
              : t(A) || ((this.state = i.InAttributeName), (this.sectionStart = this.index));
        }
        stateInSelfClosingTag(A) {
          A === E.Gt ? (this.cbs.onselfclosingtag(this.index), (this.state = i.Text), (this.sectionStart = this.index + 1), (this.isSpecial = !1)) : t(A) || ((this.state = i.BeforeAttributeName), this.stateBeforeAttributeName(A));
        }
        stateInAttributeName(A) {
          (A === E.Eq || e(A)) && (this.cbs.onattribname(this.sectionStart, this.index), (this.sectionStart = this.index), (this.state = i.AfterAttributeName), this.stateAfterAttributeName(A));
        }
        stateAfterAttributeName(A) {
          A === E.Eq
            ? (this.state = i.BeforeAttributeValue)
            : A === E.Slash || A === E.Gt
              ? (this.cbs.onattribend(o.NoValue, this.sectionStart), (this.sectionStart = -1), (this.state = i.BeforeAttributeName), this.stateBeforeAttributeName(A))
              : t(A) || (this.cbs.onattribend(o.NoValue, this.sectionStart), (this.state = i.InAttributeName), (this.sectionStart = this.index));
        }
        stateBeforeAttributeValue(A) {
          A === E.DoubleQuote
            ...
            : A === E.SingleQuote
              ...
              : t(A) || ((this.sectionStart = this.index), (this.state = i.InAttributeValueNq), this.stateInAttributeValueNoQuotes(A));
        }
        handleInAttributeValue(A, I) {
          A === I || (!this.decodeEntities && this.fastForwardTo(I))
            ? (this.cbs.onattribdata(this.sectionStart, this.index), (this.sectionStart = -1), this.cbs.onattribend(I === E.DoubleQuote ? o.Double : o.Single, this.index + 1), (this.state = i.BeforeAttributeName))
        ...
        stateInAttributeValueNoQuotes(A) {
          t(A) || A === E.Gt ? (this.cbs.onattribdata(this.sectionStart, this.index), (this.sectionStart = -1), this.cbs.onattribend(o.Unquoted, this.index), (this.state = i.BeforeAttributeName), this.stateBeforeAttributeName(A)) : this.decodeEntities && A === E.Amp && this.startEntity();
        }
        stateBeforeDeclaration(A) {
          A === E.OpeningSquareBracket ? ((this.state = i.CDATASequence), (this.sequenceIndex = 0)) : (this.state = A === E.Dash ? i.BeforeComment : i.InDeclaration);
        }
        stateInDeclaration(A) {
          (A === E.Gt || this.fastForwardTo(E.Gt)) && (this.cbs.ondeclaration(this.sectionStart, this.index), (this.state = i.Text), (this.sectionStart = this.index + 1));
        }
        stateInProcessingInstruction(A) {
          (A === E.Gt || this.fastForwardTo(E.Gt)) && (this.cbs.onprocessinginstruction(this.sectionStart, this.index), (this.state = i.Text), (this.sectionStart = this.index + 1));
        }
        stateBeforeComment(A) {
          A === E.Dash ? ((this.state = i.InCommentLike), (this.currentSequence = s.CommentEnd), (this.sequenceIndex = 2), (this.sectionStart = this.index + 1)) : (this.state = i.InDeclaration);
        }
        stateInSpecialComment(A) {
          (A === E.Gt || this.fastForwardTo(E.Gt)) && (this.cbs.oncomment(this.sectionStart, this.index, 0), (this.state = i.Text), (this.sectionStart = this.index + 1));
        }
        stateBeforeSpecialS(A) {
          const I = 32 | A;
          I === s.ScriptEnd[3] ? this.startSpecial(s.ScriptEnd, 4) : I === s.StyleEnd[3] ? this.startSpecial(s.StyleEnd, 4) : ((this.state = i.InTagName), this.stateInTagName(A));
        }
        ...
        startEntity() {
          (this.baseState = this.state), (this.state = i.InEntity), (this.entityStart = this.index), this.entityDecoder.startEntity(this.xmlMode ? D.FJ.Strict : this.baseState === i.Text || this.baseState === i.InSpecialTag ? D.FJ.Legacy : D.FJ.Attribute);
        }
        stateInEntity() {
          const A = this.entityDecoder.write(this.buffer, this.index - this.offset);
          A >= 0 ? ((this.state = this.baseState), 0 === A && (this.index = this.entityStart)) : (this.index = this.offset + this.buffer.length - 1);
        }
        cleanup() {
          this.running &&
            ...
            (this.state === i.Text || (this.state === i.InSpecialTag && 0 === this.sequenceIndex)
              ...
              : (this.state === i.InAttributeValueDq || this.state === i.InAttributeValueSq || this.state === i.InAttributeValueNq) && (this.cbs.onattribdata(this.sectionStart, this.index), (this.sectionStart = this.index)));
        }
        shouldContinue() {
        ...
        emitCodePoint(A, I) {
          this.baseState !== i.Text && this.baseState !== i.InSpecialTag
            ? (this.sectionStart < this.entityStart && this.cbs.onattribdata(this.sectionStart, this.entityStart), (this.sectionStart = this.entityStart + I), (this.index = this.sectionStart - 1), this.cbs.onattribentity(A))
            : (this.sectionStart < this.entityStart && this.cbs.ontext(this.sectionStart, this.entityStart), (this.sectionStart = this.entityStart + I), (this.index = this.sectionStart - 1), this.cbs.ontextentity(A, this.sectionStart));
        }
      }
    },
    3808: (_A, I, g) => {
    ...
    6570: (_A, I, g) => {
        ...
        e = {
          get(A, I, g) {
            if (A instanceof IDBTransaction) {
              ...
              if ("store" === I) return g.objectStoreNames[1] ? void 0 : g.objectStore(g.objectStoreNames[0]);
            }
            return s(A[I]);
          },
          set: (A, I, g) => ((A[I] = g), !0),
      ...
      function s(A) {
        ...
        const I = ((A) => {
          if ("function" === typeof A)
            return (Q || (Q = [IDBCursor.prototype.advance, IDBCursor.prototype.continue, IDBCursor.prototype.continuePrimaryKey])).includes(A)
              ? function (...I) {
          ...
          return (A instanceof IDBTransaction &&
            ((A) => {
              if (o.has(A)) return;
              const I = new Promise((I, g) => {
                const B = () => {
                    A.removeEventListener("complete", Q), A.removeEventListener("error", C), A.removeEventListener("abort", C);
                  },
                  Q = () => {
                    I(), B();
                  },
                ...
                A.addEventListener("complete", Q), A.addEventListener("error", C), A.addEventListener("abort", C);
              });
              o.set(A, I);
            })(A),
      ...
      function w(A, I, { blocked: g, upgrade: B, blocking: Q, terminated: C } = {}) {
        ...
        return (
          ...
          i
            .then((A) => {
              C && A.addEventListener("close", () => C()), Q && A.addEventListener("versionchange", (A) => Q(A.oldVersion, A.newVersion, A));
            })
            .catch(() => {}),
          i
        );
      ...
      e = { ...(C = e), get: (A, I, g) => S(A, I) || C.get(A, I, g), has: (A, I) => !!S(A, I) || C.has(A, I) };
      ...
      async function* F(...A) {
        ...
        const g = new Proxy(I, R);
        for (n.set(g, I), t.set(g, a(I)); I; ) yield g, (I = await (N.get(g) || I.continue())), N.delete(g);
      }
      function k(A, I) {
        return (I === Symbol.asyncIterator && i(A, [IDBIndex, IDBObjectStore, IDBCursor])) || ("iterate" === I && i(A, [IDBIndex, IDBObjectStore]));
      }
      e = { ...(E = e), get: (A, I, g) => (k(A, I) ? F : E.get(A, I, g)), has: (A, I) => k(A, I) || E.has(A, I) };
    },
    1652: (_A, I, g) => {
      g.d(I, { N: () => B });
      function _B() {
        return "10000000000".replace(/[018]/g, (A) => (A ^ (crypto.getRandomValues(new Uint8Array(1))[0] & (15 >> (A / 4)))).toString(16));
      }
    },
    3907: (_A, I, g) => {
      let B;
      ...
      function a(A, I, g) {
        ...
        if (E !== B) {
          ...
          const I = s(A, o().subarray(Q + E, Q + B));
      ...
      function h(A) {
        const I = B.__wbindgen_export_2.get(A);
        return B.__externref_table_dealloc(A), I;
      }
      const c = "undefined" === typeof FinalizationRegistry ? { register: () => {}, unregister: () => {} } : new FinalizationRegistry((A) => B.__wbg_rewriter_free(A >>> 0, 1));
      class S {
        __destroy_into_raw() {
        ...
        rewrite_js(A, I, g, Q) {
          const C = a(A, B.__wbindgen_malloc, B.__wbindgen_realloc),
            E = t,
        ...
        rewrite_js_bytes(A, I, g, Q) {
          let C,
            E = ((C = (0, B.__wbindgen_malloc)(+A.length, 1) >>> 0), o().set(A, C / 1), (t = A.length), C),
            i = t,
        ...
        if ("function" === typeof Response && A instanceof Response) {
          if ("function" === typeof WebAssembly.instantiateStreaming)
            try {
              ...
              if ("application/wasm" !== A.headers.get("Content-Type")) console.warn("`WebAssembly.instantiateStreaming` failed because your server does not serve Wasm with `application/wasm` MIME type. Falling back to `WebAssembly.instantiate` which is slower. Original error:\n", I);
              else throw I;
            }
      ...
      function y() {
        ...
        return (
          (A.wbg = {}),
          (A.wbg.__wbg_buffer_609cc3eee51ed158 = (A) => A.buffer),
          (A.wbg.__wbg_call_7cccdd69e0791ae2 = function () {
            return C((A, I, g) => A.call(I, g), arguments);
          }),
          (A.wbg.__wbg_call_833bed5770ea2041 = function () {
            return C((A, I, g, B) => A.call(I, g, B), arguments);
          }),
          (A.wbg.__wbg_get_67b2ba62fc30de12 = function () {
            return C((A, I) => Reflect.get(A, I), arguments);
          }),
          (A.wbg.__wbg_new_405e22f390576ce2 = () => ({})),
          (A.wbg.__wbg_new_78feb108b6472713 = () => []),
          (A.wbg.__wbg_new_9ffbe0a71eff35e3 = function () {
            return C((A, I) => new URL(D(A, I)), arguments);
          }),
          (A.wbg.__wbg_new_a12002a7f91c75be = (A) => new Uint8Array(A)),
          (A.wbg.__wbg_newwithbase_161c299e7a34e2eb = function () {
            return C((A, I, g, B) => new URL(D(A, I), D(g, B)), arguments);
          }),
          (A.wbg.__wbg_newwithbyteoffsetandlength_d97e637ebe145a9a = (A, I, g) => new Uint8Array(A, I >>> 0, g >>> 0)),
          (A.wbg.__wbg_scramtag_3a255d78b157986d = (A) => {
            const I = a((0, Q.N)(), B.__wbindgen_malloc, B.__wbindgen_realloc),
              g = t;
            r().setInt32(A + 4, g, !0), r().setInt32(A + 0, I, !0);
          }),
          (A.wbg.__wbg_set_bb8cecf6a62b9f46 = function () {
            return C((A, I, g) => Reflect.set(A, I, g), arguments);
          }),
          (A.wbg.__wbg_toString_5285597960676b7b = (A) => A.toString()),
          (A.wbg.__wbg_toString_c813bbd34d063839 = (A) => A.toString()),
          (A.wbg.__wbindgen_boolean_get = (A) => ("boolean" === typeof A ? +!!A : 2)),
          (A.wbg.__wbindgen_error_new = (A, I) => Error(D(A, I))),
          (A.wbg.__wbindgen_init_externref_table = () => {
            const A = B.__wbindgen_export_2,
              I = A.grow(4);
            A.set(0, void 0), A.set(I + 0, void 0), A.set(I + 1, null), A.set(I + 2, !0), A.set(I + 3, !1);
          }),
          (A.wbg.__wbindgen_is_function = (A) => "function" === typeof A),
          (A.wbg.__wbindgen_memory = () => B.memory),
          (A.wbg.__wbindgen_string_get = (A, I) => {
            const g = "string" === typeof I ? I : void 0;
            var Q = null == g ? 0 : a(g, B.__wbindgen_malloc, B.__wbindgen_realloc),
              C = t;
            r().setInt32(A + 4, C, !0), r().setInt32(A + 0, Q, !0);
          }),
          (A.wbg.__wbindgen_string_new = (A, I) => D(A, I)),
          (A.wbg.__wbindgen_throw = (A, I) => {
            throw Error(D(A, I));
          }),
          A
        );
      ...
      function N(A, I) {
        return (B = A.exports), (R.__wbindgen_wasm_module = I), (w = null), (i = null), B.__wbindgen_start(), B;
      }
      function n(A) {
        if (void 0 !== B) return B;
        void 0 !== A && (Object.getPrototypeOf(A) === Object.prototype ? ({ module: A } = A) : console.warn("using deprecated parameters for `initSync()`; pass a single object instead"));
        const I = y();
        return A instanceof WebAssembly.Module || (A = new WebAssembly.Module(A)), N(new WebAssembly.Instance(A, I), A);
      }
      async function R(A) {
        if (void 0 !== B) return B;
        void 0 !== A && (Object.getPrototypeOf(A) === Object.prototype ? ({ module_or_path: A } = A) : console.warn("using deprecated parameters for the initialization function; pass a single object instead")), void 0 === A && (A = new URL("wasm_bg.wasm", ""));
        const I = y();
        ("string" === typeof A || ("function" === typeof Request && A instanceof Request) || ("function" === typeof URL && A instanceof URL)) && (A = fetch(A));
        const { instance: g, module: Q } = await G(await A, I);
        return N(g, Q);
      }
    },
  },
...
(o.n = (A) => {
  var I = A?.__esModule ? () => A.default : () => A;
  return o.d(I, { a: I }), I;
}),
  (o.d = (A, I) => {
    for (var g in I) o.o(I, g) && !o.o(A, g) && Object.defineProperty(A, g, { enumerable: !0, get: I[g] });
  }),
  (o.o = (A, I) => Object.hasOwn(A, I)),
  (o.r = (A) => {
