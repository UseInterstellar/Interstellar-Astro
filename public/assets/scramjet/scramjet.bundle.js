var A,
  ...
  E = {
    ...
    336: (A, I, g) => {
      ...
      class r {
        ...
        hook() {
          ...
          for (const A of (I.sort((A, I) => (A.order || 0) - (I.order || 0)), I)) !A.enabled || A.enabled(this) ? A.default(this, this.global) : A.disabled && A.disabled(this, this.global);
        }
        get url() {
        ...
        set url(A) {
          ...
          this.frame && this.frame.dispatchEvent(I), I.defaultPrevented || (this.global.location.href = (0, o.Oy)(I.url, this.meta));
        }
        Proxy(A, I) {
          if (Array.isArray(A)) {
            ...
            get(I) {
              ...
              return new Proxy(g, {
                get(A, I) {
                  ...
                  return "function" == typeof Q ? new Proxy(Q, { apply: (A, I, B) => Reflect.apply(A, g, B) }) : I in CSSStyleDeclaration.prototype || !Q ? Q : (0, B.f)(Q);
                },
    ...
    9201: (A, I, g) => {
      ...
      function o(A, I) {
        ...
        A.Proxy("EventTarget.prototype.addEventListener", {
          ...
          A.Trap("ServiceWorkerContainer.prototype.ready", { get: (A) => new Promise((A) => A(registration)) }),
          A.Trap("ServiceWorkerContainer.prototype.controller", { get: (A) => registration?.active }),
    ...
    582: (A, I, g) => {
      ...
      var B = g(37);
      const Q = (A) => (0, B.U5)("captureErrors", A.url);
      function C(A, I = []) {
        switch (typeof A) {
          case "string":
            break;
    ...
    6143: (A, I, g) => {
      ...
      var B = g(37),
        Q = g(1472);
      const C = (A) => (0, B.U5)("cleanErrors", A.url);
      function E(A, I) {
        const g = (A, I) => {
          let g = A.stack;
    ...
    581: (A, I, g) => {
      ...
      function D(A, I) {
        Object.defineProperty(I, C.$W.globals.wrapfn, { value: A.wrapfn, writable: !1, configurable: !1, enumerable: !1 }),
          ...
          Object.defineProperty(I, C.$W.globals.cleanrestfn, { value: (A) => {}, writable: !1, configurable: !1, enumerable: !1 }),
          ...
          Object.defineProperty(I, C.$W.globals.trysetfn, { value: (g, B, Q) => g instanceof I.Location && ((A.locationProxy.href = Q), !0), writable: !1, configurable: !1 });
      }
    },
    1229: (A, I, g) => {
      ...
      class C {
        ...
        hook() {
          (this.client.global.registration = {
            ...
            active: { scriptURL: this.client.url.href, state: "activated", onstatechange: null, onerror: null, postMessage: () => {}, addEventListener: () => {}, removeEventListener: () => {}, dispatchEvent: (A) => !1 },
        ...
        if ("fetch" === C) {
          ...
          for (const i of C) {
            ...
            (D.respondWith = (A) => {
              ...
              Q.log("to fn", D),
              i.proxiedCallback(new Proxy(D, { get: (A, I, g) => "isTrusted" === I || Reflect.get(A, I) })),
...
self.WASM = '${g}';`),
      ...
      async function c(A, I, g, B, i, o, e, s, a, w, h) {
        ...
        for (const I in (await e.setCookies(n instanceof Array ? n : [n], A), N)) Array.isArray(N[I]) && (N[I] = N[I][0]);
        if (
          ((A, I) => {
    ...
    5949: (A, I, g) => {
      g.d(I, { s: () => B });
      const B = new Uint16Array("Ȁaglq	\x15\x18\x1bɭ\x0f\0\0\x12p;䀦os;䀧t;䀾t;䀼uot;䀢".split("").map((A) => A.charCodeAt(0)));
    },
    9496: () => {},
    8466: (A, I, g) => {
